...
class UserTable(models.Model):
    ...
    show_all_employees = models.BooleanField(
        default=True, blank=True, null=True)
    EmployeeID = models.BigIntegerField(blank=True, null=True)
    show_all_accounts = models.BooleanField(default=False, blank=True, null=True)
    # ID = models.BigIntegerField()
...
class AccountLedger(models.Model):
    ...
    LedgerCode = models.CharField(
        max_length=128, blank=True, null=True, db_index=True)
    AccountGroupUnder = models.BigIntegerField(
    ...
    class Meta:
        ...
        unique_together = ("CompanyID", "LedgerID")
...
class Branch(models.Model):
    ...
    vat_on_sales = models.ForeignKey(
        "brands.AccountLedger",
        related_name="vat_on_sales_log",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    vat_on_purchase = models.ForeignKey(
        "brands.AccountLedger",
        related_name="vat_on_purchase_log",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    vat_on_expense = models.ForeignKey(
        "brands.AccountLedger",
        related_name="vat_on_expense_log",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    ...
    central_gst_on_sales = models.ForeignKey(
        "brands.AccountLedger",
        related_name="central_gst_on_sales_log",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    state_gst_on_sales = models.ForeignKey(
        "brands.AccountLedger",
        related_name="state_gst_on_sales_log",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    integrated_gst_on_sales = models.ForeignKey(
        "brands.AccountLedger",
        related_name="integrated_gst_on_sales_log",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    central_gst_on_expense = models.ForeignKey(
        "brands.AccountLedger",
        related_name="central_gst_on_expense_log",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    central_gst_on_purchase = models.ForeignKey(
        "brands.AccountLedger",
        related_name="central_gst_on_purchase_log",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    state_gst_on_purchase = models.ForeignKey(
        "brands.AccountLedger",
        related_name="state_gst_on_purchase_log",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    integrated_gst_on_purchase = models.ForeignKey(
        "brands.AccountLedger",
        related_name="integrated_gst_on_purchase_log",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    state_gst_on_payment = models.ForeignKey(
        "brands.AccountLedger",
        related_name="state_gst_on_payment_log",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    ...
    round_off_sales = models.ForeignKey(
        "brands.AccountLedger",
        related_name="round_off_sales_log",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    discount_on_sales = models.ForeignKey(
        "brands.AccountLedger",
        related_name="discount_on_sales_log",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    discount_on_purchase = models.ForeignKey(
        "brands.AccountLedger",
        related_name="discount_on_purchase_log",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    discount_on_payment = models.ForeignKey(
        "brands.AccountLedger",
        related_name="discount_on_payment_log",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    discount_on_receipt = models.ForeignKey(
        "brands.AccountLedger",
        related_name="discount_on_receipt_log",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    discount_on_loyalty = models.ForeignKey(
        "brands.AccountLedger",
        related_name="discount_on_loyalty_log",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    round_off_purchase = models.ForeignKey(
        "brands.AccountLedger",
        related_name="round_off_purchase_log",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
...
class Branch_Log(models.Model):
    ...
    regional_office = models.ForeignKey(
        "brands.Branch",
        related_name="regionaloffice_log",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    ...
    central_gst_on_sales = models.ForeignKey(
        "brands.AccountLedger",
        related_name="central_gst_on_sales",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    state_gst_on_sales = models.ForeignKey(
        "brands.AccountLedger",
        related_name="state_gst_on_sales",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    kerala_flood_cess = models.ForeignKey(
        "brands.AccountLedger",
        related_name="kerala_flood_cess",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    integrated_gst_on_sales = models.ForeignKey(
        "brands.AccountLedger",
        related_name="integrated_gst_on_sales",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    tax1_on_service_sales = models.ForeignKey(
        "brands.AccountLedger",
        related_name="tax1_on_service_sales",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    ...
    discount_on_sales = models.ForeignKey(
        "brands.AccountLedger",
        related_name="discount_on_sales",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    discount_on_purchase = models.ForeignKey(
        "brands.AccountLedger",
        related_name="discount_on_purchase",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    discount_on_payment = models.ForeignKey(
        "brands.AccountLedger",
        related_name="discount_on_payment",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    discount_on_receipt = models.ForeignKey(
        "brands.AccountLedger",
        related_name="discount_on_receipt",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    discount_on_loyalty = models.ForeignKey(
        "brands.AccountLedger",
        related_name="discount_on_loyalty",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    ...
    central_gst_on_purchase = models.ForeignKey(
        "brands.AccountLedger",
        related_name="central_gst_on_purchase",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    state_gst_on_purchase = models.ForeignKey(
        "brands.AccountLedger",
        related_name="state_gst_on_purchase",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    integrated_gst_on_purchase = models.ForeignKey(
        "brands.AccountLedger",
        related_name="integrated_gst_on_purchase",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    ...
    round_off_purchase = models.ForeignKey(
        "brands.AccountLedger",
        related_name="round_off_purchase",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    ...
    central_gst_on_expense = models.ForeignKey(
        "brands.AccountLedger",
        related_name="central_gst_on_expense",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    state_gst_on_payment = models.ForeignKey(
        "brands.AccountLedger",
        related_name="state_gst_on_payment",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
...
class Product(models.Model):
    ...
    InventoryType = models.CharField(default="StockItem", max_length=255)
    ...
    ProductImage2 = VersatileImageField(
        upload_to="uploads/", blank=True, null=True)
    ProductImage3 = VersatileImageField(
        upload_to="uploads/", blank=True, null=True)
    VegOrNonVeg = models.CharField(max_length=255, blank=True, null=True)
    Variant = models.ForeignKey(
        "brands.ProductVariants", on_delete=models.CASCADE, blank=True, null=True
    )
    ProductImage4 = VersatileImageField(
        upload_to="uploads/", blank=True, null=True)
    ProductImage5 = VersatileImageField(
        upload_to="uploads/", blank=True, null=True)
...
class ProductBarcode(models.Model):
    ...
    UnitID = models.ForeignKey(
        "brands.Unit", on_delete=models.CASCADE, blank=True, null=True
    )
    Action = models.CharField(
        max_length=128, blank=True, null=True, default="A")
    CreatedDate = models.DateTimeField(auto_now_add=True)
...
class CompanySettings(BaseModel):
    ...
    VATNumber = models.CharField(max_length=128, blank=True, null=True)
    GSTNumber = models.CharField(max_length=128, blank=True, null=True)
    LUTNumber = models.CharField(max_length=128, blank=True, null=True)
...
class LedgerPosting(models.Model):
    ...
    CreatedUserID = models.BigIntegerField(blank=True, null=True)
    IsActive = models.BooleanField(default=True)
    IsReconciliated = models.BooleanField(blank=True, null=True, default=False)
...
class QrCode(models.Model):
    voucher_type = models.CharField(max_length=280)
    master_id = models.CharField(max_length=280)
...
class SalesMaster(models.Model):
    ...
    ShippingAddress = models.ForeignKey(
        "brands.UserAdrress",related_name="ShippingAddress", on_delete=models.CASCADE, blank=True, null=True
    )
    BillingAddress = models.ForeignKey(
        "brands.UserAdrress",related_name="BillingAddress", on_delete=models.CASCADE, blank=True, null=True
    )
    TaxTaxableAmount = models.DecimalField(
        default=0.00, max_digits=20, decimal_places=8, blank=True, null=True
    )
...
class SalesMaster_Log(models.Model):
    ...
    ShippingAddress = models.ForeignKey(
        "brands.UserAdrress", related_name="ShippingAddress_log", on_delete=models.CASCADE, blank=True, null=True
    )
    BillingAddress = models.ForeignKey(
        "brands.UserAdrress", related_name="BillingAddress_log", on_delete=models.CASCADE, blank=True, null=True
    )
    TaxTaxableAmount = models.DecimalField(
        default=0.00, max_digits=20, decimal_places=8, blank=True, null=True
    )
    ...
    OrderNo = models.CharField(max_length=128, blank=True, null=True)
    DiscoundBeforeTax = models.BooleanField(default=False,blank=True, null=True)
    is_manual_roundoff = models.BooleanField(default=False,blank=True, null=True)
    Type = models.CharField(max_length=128, blank=True, null=True)
...
class SalesOrderDetails(models.Model):
    ...
    flavour = models.ForeignKey(
        "brands.Flavours", on_delete=models.CASCADE, blank=True, null=True
    )
...
class SalesOrderMaster(models.Model):
    ...
    BillingAddress = models.ForeignKey(
        "brands.UserAdrress", related_name="BillingAddressOrder", on_delete=models.CASCADE, blank=True, null=True
    )
    Table = models.ForeignKey(
        "brands.POS_Table", on_delete=models.CASCADE, blank=True, null=True
    )
    ...
    EstimateNo = models.CharField(max_length=128, blank=True, null=True)
    DiscoundBeforeTax = models.BooleanField(default=False,blank=True, null=True)
    TaxTaxableAmount = models.DecimalField(
        default=0.00, max_digits=20, decimal_places=8, blank=True, null=True
    )
...
class SalesOrderMaster_Log(models.Model):
    ...
    BillingAddress = models.ForeignKey(
        "brands.UserAdrress", related_name="BillingAddressOrder_Log", on_delete=models.CASCADE, blank=True, null=True
    )
    Table = models.ForeignKey(
        "brands.POS_Table", on_delete=models.CASCADE, blank=True, null=True
    )
...
class SalesReturnMaster(models.Model):
    ...
    ShippingAddress = models.ForeignKey(
        "brands.UserAdrress",related_name="ShippingAddressReturn", on_delete=models.CASCADE, blank=True, null=True
    )
    BillingAddress = models.ForeignKey(
        "brands.UserAdrress", related_name="BillingAddressReturn", on_delete=models.CASCADE, blank=True, null=True
    )
    CashID = models.BigIntegerField(blank=True, null=True)
    BankID = models.BigIntegerField(blank=True, null=True)
...
class SalesReturnMaster_Log(models.Model):
    ...
    ShippingAddress = models.ForeignKey(
        "brands.UserAdrress",related_name="ShippingAddressReturnLog", on_delete=models.CASCADE, blank=True, null=True
    )
    BillingAddress = models.ForeignKey(
        "brands.UserAdrress", related_name="BillingAddressReturnLog", on_delete=models.CASCADE, blank=True, null=True
    )
    CashID = models.BigIntegerField(blank=True, null=True)
    BankID = models.BigIntegerField(blank=True, null=True)
...
class StockTransferMaster_ID(models.Model):
    ...
    VoucherType = models.CharField(default="ST",max_length=128, blank=True, null=True)
...
class StockTransferMasterID_Log(models.Model):
    ...
    BranchToID = models.BigIntegerField(default=1, blank=True, null=True)
    VoucherType = models.CharField(
        default="ST", max_length=128, blank=True, null=True)
    StockOrderNo = models.CharField(max_length=128, blank=True, null=True)
    IsTaken = models.BooleanField(default=False)
...
class Activity_Log(models.Model):
    ...
    browser = models.CharField(blank=True, null=True, max_length=1000)
...
class SalesEstimateMaster(models.Model):
    ...
    VAT_Treatment = models.CharField(max_length=128, blank=True, null=True)
    Status = models.CharField(
        default="N", max_length=128, blank=True, null=True)
    ReffNo = models.CharField(max_length=128, blank=True, null=True)
    DiscoundBeforeTax = models.BooleanField(default=False,blank=True, null=True)
    TaxTaxableAmount = models.DecimalField(
        default=0.00, max_digits=20, decimal_places=8, blank=True, null=True
    )
    ...
    ShippingAddress = models.ForeignKey(
        "brands.UserAdrress",related_name="ShippingAddressEstimate", on_delete=models.CASCADE, blank=True, null=True
    )
    BillingAddress = models.ForeignKey(
        "brands.UserAdrress", related_name="BillingAddressEstimate", on_delete=models.CASCADE, blank=True, null=True
    )
    EmployeeID = models.BigIntegerField(blank=True, null=True)
...
class SalesEstimateMaster_Log(models.Model):
    ...
    ShippingAddress = models.ForeignKey(
        "brands.UserAdrress", related_name="ShippingAddressEstimate_Log", on_delete=models.CASCADE, blank=True, null=True
    )
    BillingAddress = models.ForeignKey(
        "brands.UserAdrress", related_name="BillingAddressEstimate_Log", on_delete=models.CASCADE, blank=True, null=True
    )
    EmployeeID = models.BigIntegerField(blank=True, null=True)
...
class SerialNumbers(models.Model):
    ...
    SerialNo = models.CharField(max_length=128, blank=True, null=True)
    ItemCode = models.CharField(max_length=128, blank=True, null=True)
...
class LoyaltyCustomer(models.Model):
    ...
    CardTypeID = models.ForeignKey(
        "brands.TransactionTypes",
        related_name="type_%(class)s_objects",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
    CardStatusID = models.ForeignKey(
        "brands.TransactionTypes",
        related_name="status_%(class)s_objects",
        on_delete=models.CASCADE,
        blank=True,
        null=True,
    )
...
class PrintSettingsNew(models.Model):
    ...
    TransactionName = models.CharField(max_length=128, null=True, blank=True)
    BankName = models.CharField(max_length=128, null=True, blank=True)
    AccountNumber = models.CharField(max_length=128, null=True, blank=True)
    IBANCode = models.CharField(max_length=128, null=True, blank=True)
    SwiftCode = models.CharField(max_length=128, null=True, blank=True)

    IsDigitalSign = models.BooleanField(default=False)
    IsUploadSeal = models.BooleanField(default=False)
    DigitalSignFile = models.ImageField(
    upload_to="uploads/", blank=True, null=True)
    SealFile = models.ImageField(
    upload_to="uploads/", blank=True, null=True)
    SignatureName = models.CharField(max_length=128, null=True, blank=True)
    ...
    IsSalesManPhone = models.BooleanField(default=False)
    IsQrCode = models.BooleanField(default=False)
    IsLUTNumber = models.BooleanField(default=False)
    IsTenderCash = models.BooleanField(default=False)
    IsQuantity = models.BooleanField(default=True)
    IsPaymentStatus = models.BooleanField(default=False)
    IsPlaceOfSupply = models.BooleanField(default=False)
    IsRoute = models.BooleanField(default=False)
    IsCustomerBalance = models.BooleanField(default=False)
    IsFreeQuantity = models.BooleanField(default=False)
    IsHSNCode = models.BooleanField(default=False)
    IsSlNo = models.BooleanField(default=True)
    IsLogo = models.BooleanField(default=True)
    IsNarration = models.BooleanField(default=False)
    IsNote = models.BooleanField(default=False)
    IsGrossAmount = models.BooleanField(default=False)
    # payment
    ...
    IsAmountInWordsArabic = models.BooleanField(default=False)
    IsReceiverSignature = models.BooleanField(default=True)
    IsAuthorizedSinature = models.BooleanField(default=True)
    IsTaxPerc = models.BooleanField(default=False)
    ...
    def save(self, *args, **kwargs):
        if self.CompanyID.is_vat and self.template == "template1":
...
class InviteUsers(models.Model):
    ...
    show_all_warehouse = models.BooleanField(
        default=True, blank=True, null=True)
    DefaultWarehouse = models.BigIntegerField(default=1, blank=True, null=True)
    show_all_employees = models.BooleanField(default=True, blank=True, null=True)
    EmployeeID = models.BigIntegerField(blank=True, null=True)
    show_all_accounts = models.BooleanField(default=False, blank=True, null=True)
...
class VoucherNoGenerateTable(models.Model):
    ...
    PreFix = models.CharField(max_length=128, blank=True, null=True)
    Seperater = models.CharField(max_length=128, blank=True, null=True)
    LastInvoiceNo = models.CharField(max_length=128, blank=True, null=True)
...
class POS_Devices(models.Model):
    ...
    PriceCategoryID = models.ForeignKey(
        "brands.PriceCategory", on_delete=models.CASCADE, blank=True, null=True
    )
    ...
    StockAlert = models.CharField(max_length=256,default="ignore", blank=True, null=True)
...
class POS_DevicesRoutes(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    CompanyID = models.ForeignKey(
        "brands.CompanySettings", on_delete=models.CASCADE, blank=True, null=True
    )
    DeviceID = models.ForeignKey(
        "brands.POS_Devices", on_delete=models.CASCADE, blank=True, null=True
    )
    RouteID = models.ForeignKey(
        "brands.Route", on_delete=models.CASCADE, blank=True, null=True
    )

    class Meta:
        db_table = "pos_devices_route"
        verbose_name = _("pos_devices_route")
        verbose_name_plural = _("pos_devices_routes")
        ordering = ("id",)
...
class POS_DevicesUsers(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    CompanyID = models.ForeignKey(
        "brands.CompanySettings", on_delete=models.CASCADE, blank=True, null=True
    )
    ...
    UserTableID = models.ForeignKey(
        "brands.UserTable", on_delete=models.CASCADE, blank=True, null=True
    )
    is_edit = models.BooleanField(default=False, blank=True, null=True)
    is_delete = models.BooleanField(default=False, blank=True, null=True)

    class Meta:
        db_table = "pos_devices_user"
        verbose_name = _("pos_devices_user")
        verbose_name_plural = _("pos_devices_users")
        ordering = ("id",)
...
class UserRoleSettingsModel(models.Model):
    ...
    print_permission = models.BooleanField(
        default=False, blank=True, null=True)
    block_date = models.BooleanField(default=False, blank=True, null=True)
    UpdatedDate = models.DateTimeField(blank=True, null=True)
    UpdatedUserID = models.BigIntegerField(blank=True, null=True)
    PreDate = models.BigIntegerField(default=0,blank=True, null=True)
    PostDate = models.BigIntegerField(default=0,blank=True, null=True)
...
class StockManagementMaster(models.Model):
    ...
    Notes = models.TextField(blank=True, null=True)
    WarehouseID = models.BigIntegerField(blank=True, null=True)
    TotalExcessOrShortage = models.DecimalField(
        default=0.00, max_digits=20, decimal_places=8, blank=True, null=True
    )
    TotalQty = models.DecimalField(
        default=0.00, max_digits=20, decimal_places=8, blank=True, null=True
    )
    TotalExcessAmount = models.DecimalField(
        default=0.00, max_digits=20, decimal_places=8, blank=True, null=True
    )
    TotalShortageAmount = models.DecimalField(
        default=0.00, max_digits=20, decimal_places=8, blank=True, null=True
    )
    GrandTotal = models.DecimalField(
        default=0.00, max_digits=20, decimal_places=8, blank=True, null=True
...
class StockManagementDetails(models.Model):
    ...
    LogID = models.BigIntegerField(default=0)
    BatchCode = models.CharField(
        default="0", max_length=255, blank=True, null=True)
    is_damage = models.BooleanField(default=False, blank=True, null=True)
...
class BankReconciliationMaster(models.Model):
    ...
    BankReconciliationMasterID = models.BigIntegerField()
    BranchID = models.BigIntegerField()
    VoucherNo = models.CharField(max_length=128, blank=True, null=True)
    Date = models.DateField(blank=True, null=True)
    Action = models.CharField(
        max_length=128, blank=True, null=True, default="A")
    ClosingBalance = models.DecimalField(
        default=0.00, max_digits=20, decimal_places=8, blank=True, null=True
    )
    ...
    VoucherType = models.CharField(
        max_length=128, blank=True, null=True, default="BRC")
    BankID = models.BigIntegerField(blank=True, null=True)
    Differences = models.DecimalField(
        default=0.00, max_digits=20, decimal_places=8, blank=True, null=True
    )
    ClearedAmt = models.DecimalField(
        default=0.00, max_digits=20, decimal_places=8, blank=True, null=True
    )
    BankStatement = models.FileField(
        upload_to="reconciliation_bank_statements/",
        blank=True,
        null=True,
        max_length=254,
    )
    CreatedDate = models.DateField(blank=True, null=True)
    LastUDate = models.DateField(blank=True, null=True)
    CreatedUserID = models.BigIntegerField(blank=True, null=True)
    Type = models.CharField(max_length=128, blank=True, null=True)

    class Meta:
        db_table = "bank_reconciliation_master"
        verbose_name = _("bank_reconciliation_master")
        verbose_name_plural = _("bank_reconciliation_master")
        unique_together = (
            ("CompanyID", "BankReconciliationMasterID", "BranchID"),)
        ordering = (
            "-id",
            "CreatedDate",
        )
...
class BankReconciliationMaster_Log(models.Model):
    CompanyID = models.ForeignKey(
        "brands.CompanySettings", on_delete=models.CASCADE, blank=True, null=True
    )
    ID = models.AutoField(primary_key=True)
    ...
    class Meta:
        db_table = "bank_reconciliation_master_log"
        verbose_name = _("bank_reconciliation_master_log")
        verbose_name_plural = _("bank_reconciliation_masters_log")
        ordering = (
            "-ID",
            "CreatedDate",
        )
...
class BankReconciliationDetails(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    CompanyID = models.ForeignKey(
        "brands.CompanySettings", on_delete=models.CASCADE, blank=True, null=True
    )
    BankReconciliationDetailsID = models.BigIntegerField()
    BranchID = models.BigIntegerField()
    Date = models.DateField(blank=True, null=True)
    RelativeLedgerName = models.CharField(
        max_length=255, blank=True, null=True)
    TransactionType = models.CharField(max_length=255, blank=True, null=True)
    ChecqueOrRefNo = models.CharField(max_length=255, blank=True, null=True)
    InstrOrDueDate = models.DateField(blank=True, null=True)
    BankDate = models.DateField(blank=True, null=True)
    Debit = models.DecimalField(
        default=0.00, max_digits=20, decimal_places=8, blank=True, null=True
    )
    Credit = models.DecimalField(
    ...
    BankReconciliationMasterID = models.BigIntegerField()
    VoucherMasterID = models.BigIntegerField(blank=True, null=True)
    RelativeLedgerID = models.BigIntegerField(blank=True, null=True)
    PaymentGateway = models.CharField(max_length=128, blank=True, null=True)
    PaymentStatus = models.BooleanField(default=False, blank=True, null=True)
    LedgerPostid = models.ForeignKey(
        "brands.LedgerPosting", on_delete=models.CASCADE, blank=True, null=True
    )
    IsReconciliate = models.BooleanField(blank=True, null=True, default=False)

    class Meta:
        db_table = "bank_reconciliation_details"
        verbose_name = _("bank_reconciliation_details")
        verbose_name_plural = _("bank_reconciliation_detailses")
        unique_together = (
            ("CompanyID", "BankReconciliationDetailsID", "BranchID"),)
        ordering = ("-id",)
...
class BankReconciliationDetails_Log(models.Model):
    CompanyID = models.ForeignKey(
        "brands.CompanySettings", on_delete=models.CASCADE, blank=True, null=True
    )
    ID = models.AutoField(primary_key=True)
    ...
    class Meta:
        db_table = "bank_reconciliation_details_log"
        verbose_name = _("bank_reconciliation_details_log")
        verbose_name_plural = _("bank_reconciliation_details_log")
        ordering = ("-ID",)
...
class BillWiseMaster(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    CompanyID = models.ForeignKey(
        "brands.CompanySettings", on_delete=models.CASCADE, blank=True, null=True
    )
    BranchID = models.BigIntegerField()
    BillwiseMasterID = models.BigIntegerField()
    InvoiceNo = models.CharField(max_length=128, blank=True, null=True)
    TransactionID = models.BigIntegerField(blank=True, null=True)
    VoucherType = models.CharField(max_length=128, blank=True, null=True)
    VoucherDate = models.DateField(blank=True, null=True)
    ...
    class Meta:
        db_table = "billwise_master"
        verbose_name = _("billwise_master")
        verbose_name_plural = _("billwise_master")
        unique_together = (("CompanyID", "BillwiseMasterID", "BranchID"),)
        ordering = (
            "-id",
        )
...
class BillWiseDetails(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    CompanyID = models.ForeignKey(
        "brands.CompanySettings", on_delete=models.CASCADE, blank=True, null=True
    )
    BranchID = models.BigIntegerField()
    BillwiseDetailsID = models.BigIntegerField()
    BillwiseMasterID = models.BigIntegerField()
    InvoiceNo = models.CharField(max_length=128, blank=True, null=True)
    VoucherType = models.CharField(max_length=128, blank=True, null=True)
    ...
    PaymentVoucherType = models.CharField(
        max_length=128, blank=True, null=True)
    PaymentInvoiceNo = models.CharField(
        max_length=128, blank=True, null=True)

    class Meta:
        db_table = "billwise_details"
        verbose_name = _("billwise_details")
        verbose_name_plural = _("billwise_details")
        unique_together = (("CompanyID", "BillwiseDetailsID", "BranchID"),)
        ordering = (
            "-id",
        )
...
class POS_Printer(models.Model):
    ...
    PrinterID = models.BigIntegerField()
    BranchID = models.BigIntegerField()
    Action = models.CharField(
        max_length=128, blank=True, null=True, default="A")
    PrinterName = models.CharField(max_length=128)
    IPAddress = models.CharField(max_length=128, blank=True, null=True)
    IsActive = models.BooleanField(default=True)
    CreatedUserID = models.BigIntegerField(blank=True, null=True)
    CreatedDate = models.DateTimeField(auto_now_add=True)
    ...
    class Meta:
        db_table = "Printers_Printer"
        verbose_name = _("Printer")
        verbose_name_plural = _("Printers")
        unique_together = (("CompanyID", "PrinterID", "BranchID"),)
        ordering = ("-CreatedDate", "PrinterID")

    def __unicode__(self):
        return str(self.PrinterID)
...
class ProductVariants(models.Model):
    ...
    Action = models.CharField(
        max_length=128, blank=True, null=True, default="A")
    VariantName = models.CharField(max_length=128)
    Amount = models.DecimalField(
        default=0.00, max_digits=20, decimal_places=8, blank=True, null=True
    )
    IsActive = models.BooleanField(default=True)
    ...
    class Meta:
        db_table = "product_variants_Variant"
        verbose_name = _("Variant")
        verbose_name_plural = _("Variants")
        unique_together = (("CompanyID", "VariantID", "BranchID"),)
        ordering = ("-CreatedDate", "VariantID")

    def __unicode__(self):
        return str(self.VariantID)