...
from api.v10.salesOrderDetails.serializers import SalesOrderDetailsSerializer, SalesOrderDetailsRestSerializer, SalesOrderDetailsDummySerializer
from api.v10.brands.serializers import ListSerializer
from api.v10.salesOrderDetails.functions import generate_serializer_errors
from rest_framework import status
from api.v10.salesOrderDetails.functions import get_auto_id
import datetime
...
def create_salesOrderDetails(request):
    ...
    if serialized.is_valid():
        ...
        SalesOrderDetailsID = get_auto_id(
            SalesOrderDetails, BranchID, DataBase)
...
def list_salesOrderDetailsDummy(request):
    ...
    if serialized1.is_valid():
        ...
        if SalesOrderDetailsDummy.objects.filter(BranchID=BranchID).exists():
            ...
            instances = SalesOrderDetailsDummy.objects.filter(
                BranchID=BranchID)
            ...
            serialized = SalesOrderDetailsDummySerializer(
