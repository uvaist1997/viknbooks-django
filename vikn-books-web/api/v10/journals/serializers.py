...
class JournalMasterRestSerializer(serializers.ModelSerializer):
    ...
    def get_JournalDetails(self, instances):
        ...
        journal_details = JournalDetails.objects.filter(
            JournalMasterID=instances.JournalMasterID, BranchID=instances.BranchID, CompanyID=CompanyID).order_by('JournalDetailsID')
    ...
    def get_selected_ledgers(self, instances):
        CompanyID = self.context.get("CompanyID")
        journal_details = JournalDetails.objects.filter(
            JournalMasterID=instances.JournalMasterID, BranchID=instances.BranchID, CompanyID=CompanyID)
...
class JournalDetailsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'BranchID', 'JournalMasterID', 'LedgerID', 'Debit',
                  'Credit', 'Narration', 'Action', 'CreatedDate', 'CreatedUserID')
