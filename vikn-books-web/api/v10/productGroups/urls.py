...
from api.v10.productGroups import views
...
urlpatterns = [
    ...
    url(r'^setDefault-productGroups/$', views.setDefault_productGroups, name='setDefault_productGroups'),
    url(r'^search-productGroup-list/$', views.search_productGroup_list,
        name='search_productGroup_list'),
]
