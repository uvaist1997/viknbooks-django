...
from api.v10.receiptMaster import views


urlpatterns = [
    url(r'^create-receiptMaster/$', views.create_receiptMaster,
        name='create_receiptMaster'),
    ...
    url(r'^edit/receiptMaster/(?P<pk>.*)/$',
        views.edit_receiptMaster, name='edit_receiptMaster'),
