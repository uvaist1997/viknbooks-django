...
from api.v10.salesApp import views
...
urlpatterns = [
    ...
    url(r'^salesApp-create-salesOrder/$', views.salesApp_create_salesOrder,
        name='salesApp_create_salesOrder'),
    ...
    url(r'^salesApp-create-expense/$', views.salesApp_create_expense,
        name='salesApp_create_expense'),
    url(r'^salesApp-edit/expense/(?P<pk>.*)/$',
        views.salesApp_edit_expense, name='salesApp_edit_expense'),
    url(r'^salesApp-view/expense/(?P<pk>.*)/$',
        views.salesApp_expense, name='salesApp_expense'),
    ...
    url(r'^list-stock/transfer/$', views.list_stock_transfer,
        name='list_stock_transfer'),
    url(
    ...
    url(r'^salesApp/profile/$', views.salesApp_profile,
        name='salesApp_profile'),

    url(r'^faera-stock-report/$', views.faera_stock_report,
        name='faera_stock_report'),

    url(r'^faera-payment-modes/$', views.faera_payment_modes,
        name='faera_payment_modes'),
    url(r'^default-values/$', views.default_values,
        name='default_values'),
