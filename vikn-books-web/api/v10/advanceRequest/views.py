...
from api.v10.advanceRequest.functions import (
    generate_serializer_errors,
    get_auto_DepartmentID,
    get_auto_id,
)
from api.v10.advanceRequest.serializers import (
    AdvanceApproveSerializer,
    AdvanceRequestRestSerializer,
...
def advanceRequest(request, pk):
    ...
    if AdvanceRequest.objects.filter(pk=pk, CompanyID=CompanyID).exists():
        ...
        response_data = {"StatusCode": 6001, "message": "Advance Request Not Found!"}
