...
from api.v10.openingStock import views
...
urlpatterns = [
    ...
    url(r'^create-openingStock-master-data/$', views.create_openingStock_master_data,
        name='create_openingStock_master_data'),

    url(r'^create-openingStock-details-data/$', views.create_openingStock_details_data,
        name='create_openingStock_details_data'),
    url(r'^openingStock-web-export-excel/$', views.openingStock_web_export_excel,
        name='openingStock_web_export_excel'),
]
