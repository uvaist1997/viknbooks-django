...
from api.v10.workOrder import views
...
urlpatterns = [
    ...
    url(r'^create-workorder-new/$', views.create_workorder_new, name='create_workorder_new'),
    url(r'^edit-workorder-new/(?P<pk>.*)/$',
        views.edit_workorder_new, name='edit_workorder_new'),
]
