...
from api.v10.users import views
...
urlpatterns = [
    ...
    url(
        r"^delete/userType/(?P<pk>.*)/$", views.delete_userType, name="delete_userType"
    ),
    url(
        r"^create-general-settings/$",
        views.create_general_settings,
        name="create_general_settings",
    ),
    url(
        r"^general-settings-list/$",
        views.general_settings_list,
    ...
    url(r"^activity-log-solve/$", views.activity_log_solve, name="activity_log_solve"),
    url(r"^activity-log/(?P<pk>.*)/$", views.activity_log, name="activity_log"),
    url(
        r"^create-software-version/$",
        views.create_software_version,
    ...
    url(
        r"^get-company-details/$", views.get_company_details, name="get_company_details"
    ),
    url(
        r"^get-last/user/token/$", views.get_last_user_token, name="get_last_user_token"
    ),
    ...
    url(
        r"^render-one-time-template/$",
        views.render_one_time_template,
        name="render_one_time_template",
    ),
    url(
        r"^resend-verification-code/$",
        views.resend_verification_code,
        name="resend_verification_code",
    ),
    url(r"^edit-profile/$", views.edit_profile, name="edit_profile"),
    url(r"^edit-account-info/$", views.edit_account_info, name="edit_account_info"),
    url(r"^change-password/$", views.change_password, name="change_password"),
    url(r"^change-username/$", views.change_username, name="change_username"),
    url(
        r"^delete-user-account/$", views.delete_user_account, name="delete_user_account"
    ),
    ...
    path("set-browser-uqid", views.set_browser_uqid, name="set_browser_uqid"),
]
