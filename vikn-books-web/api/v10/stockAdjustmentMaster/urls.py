...
from api.v10.stockAdjustmentMaster import views


urlpatterns = [
    url(r'^create-stockAdjustmentMaster/$',
        views.create_stockAdjustmentMaster, name='create_stockAdjustmentMaster'),
    ...
    url(r'^edit/stockAdjustmentMaster/(?P<pk>.*)/$',
        views.edit_stockAdjustmentMaster, name='edit_stockAdjustmentMaster'),
