...
from api.v10.stockManagements.serializers import StockManagementSerializer
from api.v10.brands.serializers import ListSerializer
from api.v10.stockAdjustments.functions import generate_serializer_errors, get_VoucherNo
from rest_framework import status
from api.v10.stockManagements.functions import get_stock_type,get_auto_StockDetailsID,get_auto_StockMasterID
import datetime
...
from api.v10.stockPostings.functions import get_auto_excessMasterID, get_auto_excessDetailsID, get_auto_shortageMasterID, get_auto_shortageDetailsID
...
from api.v10.sales.functions import SetBatchInStockManagement
        ...
        with transaction.atomic():
            ...
            for d in Details:
                ...
                if detailID == 0:
                    ...
                    stockManageDetail_instance.is_damage = is_damage
...
def delete_stockManagement(request, pk):
    ...
    if instances:
        for instance in instances:
            ...
            #     VoucherType = "SS"
            # elif StockType == "2":
            VoucherType = ["SA","ES","SS"]
            if StockPosting.objects.filter(CompanyID=CompanyID, VoucherMasterID=StockMasterID, BranchID=BranchID, VoucherType__in=VoucherType).exists():
                stockPostingInstances = StockPosting.objects.filter(
                    CompanyID=CompanyID, VoucherMasterID=StockMasterID, BranchID=BranchID, VoucherType__in=VoucherType)
