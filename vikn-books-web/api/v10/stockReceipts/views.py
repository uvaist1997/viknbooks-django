...
from api.v10.stockReceipts.serializers import StockReceiptMaster_IDSerializer, StockReceiptMaster_IDRestSerializer, StockReceiptDetailsSerializer, StockReceiptDetailsRestSerializer
from api.v10.brands.serializers import ListSerializer
from api.v10.stockReceipts.functions import generate_serializer_errors
from rest_framework import status
from api.v10.stockReceipts.functions import get_auto_id, get_auto_idMaster
import datetime
...
def edit_stockReceipt(request, pk):
    ...
    for stockReceiptDetail in stockReceiptDetails:
        ...
        stockReceiptDetails = StockReceiptDetails.objects.get(
            pk=pk, StockReceiptMasterID=StockReceiptMasterID, BranchID=BranchID)
...
def delete_stockReceiptMasterID(request, pk):
    ...
    if instance:
        ...
        detail_instances = StockReceiptDetails.objects.filter(
            StockReceiptMasterID=StockReceiptMasterID, BranchID=BranchID)
