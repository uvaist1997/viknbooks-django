...
from api.v10.employees import views

# app_name='companySettings'

urlpatterns = [
    url(r'^get-employee/$', views.get_employee, name='get_employee'),
    url(r'^get-categoryEmployeeList/$', views.get_categoryEmployeeList,
        name='get_categoryEmployeeList'),
    ...
    url(r'^sales-man/list/$', views.sales_man_list, name='sales_man_list'),
]
