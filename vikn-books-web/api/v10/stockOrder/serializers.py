...
from brands.models import Batch, StockPosting, GeneralSettings, StockTransferMaster_ID, StockTransferDetails, Warehouse, Product, PriceList, Unit
from django.db.models import Sum
from api.v10.products.serializers import ProductSearchSerializer
...
class StockTransferMaster_IDRestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'StockTransferMasterID', 'BranchID', 'Action', 'VoucherNo', 'Date', 'Notes', 'TransferredByID',
                  'WarehouseFromID', 'WarehouseFromName', 'WarehouseToID', 'WarehouseToName', 'TotalQty', 'GrandTotal',
                  'MaxGrandTotal', 'IsActive', 'CreatedDate', 'CreatedUserID', 'StockTransferDetails',
                  'BranchFromID', 'BranchToID', 'ProductList')
    ...
    def get_ProductList(self, instances):
        ...
        serialized = ProductSearchSerializer(produc_instances, many=True, context={
