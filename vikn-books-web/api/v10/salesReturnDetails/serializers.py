...
from brands.models import SalesReturnDetails, SalesReturnDetailsDummy, Product
...
class SalesReturnDetailsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id','BranchID','SalesReturnMasterID','DeliveryDetailsID','OrederDetailsID','ProductID',
...
class SalesReturnDetailsRestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SalesReturnDetails
        fields = ('id','SalesReturnDetailsID','BranchID','Action','SalesReturnMasterID','DeliveryDetailsID','OrederDetailsID','ProductID',
        	'Qty','FreeQty','UnitPrice',
...
class SalesReturnDetailsDummySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SalesReturnDetailsDummy
        fields = ('id','unq_id','SalesReturnDetailsID','BranchID','SalesReturnMasterID','DeliveryDetailsID','OrderDetailsID','ProductID','ProductName','Qty','FreeQty','UnitPrice','RateWithTax',
            'CostPerPrice','PriceListID','DiscountPerc','DiscountAmount','GrossAmount','TaxableAmount','VATPerc','VATAmount',
            'SGSTPerc','SGSTAmount','CGSTPerc','CGSTAmount','IGSTPerc','IGSTAmount','NetAmount','Flavour','CreatedUserID',
            'detailID','AddlDiscPercent','AddlDiscAmt','TAX1Perc','TAX1Amount','TAX2Perc','TAX2Amount','TAX3Perc','TAX3Amount')
...
class SalesReturnDetailsDeletedDummySerializer(serializers.ModelSerializer):

    class Meta:
        model = SalesReturnDetailsDummy
        fields = ('id','SalesReturnDetailsID','unq_id')