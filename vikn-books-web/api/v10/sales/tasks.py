...
from api.v10.sales.serializers import GST_CDNR_Serializer,GST_B2B_Serializer,SalesEstimateForOrderSerializer, SalesMasterSerializer, SalesMasterRestSerializer,SalesMasterRest1Serializer, SalesDetailsSerializer,\
...
from api.v10.sales.functions import set_LoyaltyCalculation,get_Program, edit_LoyaltyCalculation, generate_serializer_errors, get_month, get_stock_value
from rest_framework import status
import re,sys, os
