...
from api.v10.sales import views
...
urlpatterns = [
    ...
    url(r'^bill-wise-profit/report/$',
        views.billWise_profit_report, name='billWise_profit_report'),
    ...
    url(r'^salesEstimate-for-salesInvoice/$',
        views.salesEstimate_for_salesInvoice, name='salesEstimate_for_salesInvoice'),
    ...
    url(r'^filterd-salesEstimate/$', views.sales_filterd_sales_estimates,
        name='sales_filterd_sales_estimates'),
    url(r'^get-estimateDetails/$', views.get_estimate_details, name='get_estimate_details'),
    ...
    url(r'^daily-report-cards/$',
        views.daily_report_cards, name='daily_report_cards'),
    url(r'^daily-report-statistic/$',
        views.daily_report_statistic, name='daily_report_statistic'),
    url(r'^daily-report-topItems/$',
        views.daily_report_topItems, name='daily_report_topItems'),
    url(r'^billWise-report-excel/$',
        views.billWise_report_excel, name='billWise_report_excel'),
    
    url(r'^customer-product/sales-history/$', views.customer_product_sales_history, name='customer_product_sales_history'),
    url(r'^sales-register/report-qry/$', views.salesRegister_report_qry,
        name='salesRegister_report_qry'),
    
    url(r'^daily-report-excel/$', views.daily_report_excel,
        name='daily_report_excel'),
    
    url(r'^sale-list-page/$', views.sale_list_page, name='sale_list_page'),
    url(r'expense-summary-report/$', views.expense_summary_report, name='expense_summary_report'),
    url(r'^single/sales/(?P<pk>.*)/$',
        views.single_salesMaster, name='single_salesMaster'),
    
    url(r'^quick/report/$', views.quick_report, name='quick_report'),
    
    url(r'^product-summary/report/$', views.product_summary_report,
        name='product_summary_report'),
    url(r'^vat-return/report/$', views.vat_return_report,
