...
from api.v10.purchaseOrderDetails.serializers import PurchaseOrderDetailsSerializer, PurchaseOrderDetailsRestSerializer, PurchaseOrderDetailsDummySerializer
from api.v10.brands.serializers import ListSerializer
from api.v10.purchaseOrderDetails.functions import generate_serializer_errors
from rest_framework import status
from api.v10.purchaseOrderDetails.functions import get_auto_id
import datetime
...
def list_purchaseOrderDetailsDummy(request):
    ...
    if serialized1.is_valid():
        ...
        if PurchaseOrderDetailsDummy.objects.filter(BranchID=BranchID).exists():
            ...
            instances = PurchaseOrderDetailsDummy.objects.filter(
                BranchID=BranchID)
            ...
            serialized = PurchaseOrderDetailsDummySerializer(
