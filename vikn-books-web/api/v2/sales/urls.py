...
from api.v2.sales import views
...
urlpatterns = [
    ...
    url(r'^view/salesMaster/(?P<pk>.*)/$', views.salesMaster, name='salesMaster'),
    # url(r'^delete/salesDetails/(?P<pk>.*)/$', views.delete_salesDetails, name='delete_salesDetails'),
    url(r'^delete/salesMaster/(?P<pk>.*)/$', views.delete_salesMaster, name='delete_salesMaster'),

    url(r'^salesInvoice-for-salesReturn/$', views.salesInvoice_for_SalesReturn, name='salesInvoice_for_SalesReturn'),

    url(r'^sales/report/$', views.sales_report, name='sales_report'),
    url(r'^sales/integrated-report/$', views.sales_integrated_report, name='sales_report'),
    ...
    url(r'^sales-register/report/$', views.salesRegister_report, name='salesRegister_report'),
    url(r'^bill-wise/report/$', views.billWise_report, name='billWise_report'),

    url(r'^excess-stock/report/$', views.excessStock_report, name='excessStock_report'),
    url(r'^damage-stock/report/$', views.damageStock_report, name='damageStock_report'),
    ...
    url(r'^generate/print-report/$', views.generate_printReport, name='generate_printReport'),
]