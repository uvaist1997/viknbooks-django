...
from api.v2.masterTypes import views
...
urlpatterns = [
    ...
    url(r'^edit/masterType/(?P<pk>.*)/$', views.edit_masterType, name='edit_masterType'),
    url(r'^delete/masterType/(?P<pk>.*)/$', views.delete_masterType, name='delete_masterType'),
]