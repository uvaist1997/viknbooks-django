...
from api.v2.designation.serializers import DesignationSerializer, DesignationRestSerializer,DepartmentSerializer,DepartmentRestSerializer
from api.v2.brands.serializers import ListSerializer
from api.v2.designation.functions import generate_serializer_errors
from rest_framework import status
from api.v2.designation.functions import get_auto_id, get_auto_DepartmentID
...
def create_designation(request):
    ...
    if serialized.is_valid():
        ...
        designations = Designation.objects.filter(BranchID=BranchID,CompanyID=CompanyID)
...
def designations(request):
    ...
    if serialized1.is_valid():
        ...
        if Designation.objects.filter(BranchID=BranchID,CompanyID=CompanyID).exists():
            instances = Designation.objects.filter(BranchID=BranchID,CompanyID=CompanyID)
