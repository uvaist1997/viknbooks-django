...
from api.v2.kitchen.serializers import KitchenSerializer, KitchenRestSerializer
from api.v2.brands.serializers import ListSerializer
from api.v2.kitchen.functions import generate_serializer_errors
from rest_framework import status
from api.v2.kitchen.functions import get_auto_id
...
def create_kitchen(request):
    ...
    if serialized.is_valid():
        ...
        kitchens = Kitchen.objects.filter(BranchID=BranchID,CompanyID=CompanyID)
...
def kitchens(request):
    ...
    if serialized1.is_valid():
        ...
        if Kitchen.objects.filter(BranchID=BranchID,CompanyID=CompanyID).exists():
            ...
            instances = Kitchen.objects.filter(BranchID=BranchID,CompanyID=CompanyID)
