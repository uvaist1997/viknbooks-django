...
from api.v2.colors.serializers import ColorSerializer, ColorRestSerializer, TestImageSerializer, TaskFormReactSerializer
from api.v2.colors.functions import generate_serializer_errors
from rest_framework import status
from api.v2.colors.functions import get_auto_id
import datetime
import base64
...
def create_testImage(request):
    ...
    today = datetime.datetime.now()
    serialized = TestImageSerializer(data=request.data,context={"request":request})
    if serialized.is_valid():
