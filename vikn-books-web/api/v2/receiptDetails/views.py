...
from api.v2.receiptDetails.serializers import ReceiptDetailsSerializer, ReceiptDetailsRestSerializer, ReceiptDetailsDummySerializer
from api.v2.brands.serializers import ListSerializer
from api.v2.receiptDetails.functions import generate_serializer_errors
from rest_framework import status
from api.v2.receiptDetails.functions import get_auto_id
import datetime
...
def list_receiptDetailsDummy(request):
    ...
    if serialized1.is_valid():
        ...
        if ReceiptDetailsDummy.objects.filter(BranchID=BranchID).exists():
            ...
            serialized = ReceiptDetailsDummySerializer(instances,many=True,context = {"DataBase": DataBase })
