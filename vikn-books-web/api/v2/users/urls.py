...
urlpatterns = [
    ...
    url(r'^delete/userType/(?P<pk>.*)/$',views.delete_userType, name='delete_userType'),

    url(r'^create-general-settings/$', views.create_general_settings,name='create_general_settings'),
    url(r'^general-settings-list/$', views.general_settings_list,name='general_settings_list'),
