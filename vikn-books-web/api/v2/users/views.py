...
from django.contrib.auth.models import User, Group
from api.v2.users.functions import get_auto_id
from brands import models
from api.v2.general.functions import get_current_role
...
from api.v2.users.functions import send_email
...
from api.v2.users.serializers import CustomTokenSerializer
...
def user_view(request, pk):
    ...
    customer_serialized = CustomerUserViewSerializer(instance,context={"request": request})
