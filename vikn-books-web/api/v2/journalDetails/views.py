...
from api.v2.journalDetails.serializers import JournalDetailsSerializer, JournalDetailsRestSerializer, JournalDetailsDummySerializer
from api.v2.brands.serializers import ListSerializer
from api.v2.journalDetails.functions import generate_serializer_errors
from rest_framework import status
from api.v2.journalDetails.functions import get_auto_id
import datetime
...
def list_journalDetailsDummy(request):
    ...
    if serialized1.is_valid():
        ...
        if JournalDetailsDummy.objects.filter(BranchID=BranchID).exists():
            ...
            serialized = JournalDetailsDummySerializer(instances,many=True,context = {"DataBase": DataBase })
