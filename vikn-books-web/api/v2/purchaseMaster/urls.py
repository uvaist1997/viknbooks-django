...
from api.v2.purchaseMaster import views


urlpatterns = [
	url(r'^create-purchaseMaster/$', views.create_purchaseMaster, name='create_purchaseMaster'),
    ...
    url(r'^edit/purchaseMaster/(?P<pk>.*)/$', views.edit_purchaseMaster, name='edit_purchaseMaster'),
