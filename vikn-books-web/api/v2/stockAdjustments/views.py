...
ExcessStockDetails_Log,PriceList,StockPosting,StockPosting_Log,StockRate,StockTrans,ShortageStockMaster,ShortageStockMaster_Log,ShortageStockDetails,ShortageStockDetails_Log
from rest_framework.renderers import JSONRenderer
from rest_framework.decorators import api_view, permission_classes, renderer_classes
from rest_framework.response import Response
from rest_framework.permissions import AllowAny, IsAuthenticated
from api.v2.stockAdjustments.serializers import StockAdjustmentMasterSerializer, StockAdjustmentMasterRestSerializer, StockAdjustmentDetailsSerializer, StockAdjustmentDetailsRestSerializer
from api.v2.brands.serializers import ListSerializer
from api.v2.stockAdjustments.functions import generate_serializer_errors, get_VoucherNo
from rest_framework import status
from api.v2.stockAdjustments.functions import get_auto_id, get_auto_idMaster
import datetime
from main.functions import get_company
from api.v2.stockPostings.functions import  get_auto_excessMasterID,get_auto_excessDetailsID,get_auto_shortageMasterID,get_auto_shortageDetailsID
...
def edit_stockAdjustment(request,pk):
    ...
    for stockAdjustmentDetail in stockAdjustmentDetails:
        ...
        stockAdjustmentDetails_instance = StockAdjustmentDetails.objects.get(pk=pk)
...
def list_stockAdjustmentMaster(request):
    ...
    if serialized1.is_valid():
        ...
        if StockAdjustmentMaster.objects.filter(BranchID=BranchID).exists():
            ...
            serialized = StockAdjustmentMasterRestSerializer(instances,many=True)
...
def delete_stockAdjustmentMaster(request,pk):
    ...
    if instance:
        ...
        detail_instances = StockAdjustmentDetails.objects.filter(StockAdjustmentMasterID=StockAdjustmentMasterID)
