...
class AccountLedgerListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = AccountLedger
        fields = ('id','LedgerID','BranchID','LedgerName','CustomerLedgerBalance','LedgerCode','AccountGroupUnder','AccountGroupName','DisplayName','Address','City','State','Country','PostalCode','OpeningBalance','CustomerBalance','CrOrDr','Notes','IsActive','IsDefault','CreatedDate','UpdatedDate','CreatedUserID','Action')
