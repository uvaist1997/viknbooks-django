...
from api.v2.purchaseReturnMaster.serializers import PurchaseReturnMasterSerializer, PurchaseReturnMasterRestSerializer
from api.v2.brands.serializers import ListSerializer
from api.v2.purchaseReturnMaster.functions import generate_serializer_errors
from rest_framework import status
from api.v2.purchaseReturnMaster.functions import get_auto_id
import datetime
...
def list_purchaseReturnMaster(request):
    ...
    if serialized1.is_valid():
        ...
        if PurchaseReturnMaster.objects.filter(BranchID=BranchID).exists():
            ...
            serialized = PurchaseReturnMasterRestSerializer(instances,many=True)
