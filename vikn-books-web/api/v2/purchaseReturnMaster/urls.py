...
from api.v2.purchaseReturnMaster import views


urlpatterns = [
	url(r'^create-purchaseReturnMaster/$', views.create_purchaseReturnMaster, name='create_purchaseReturnMaster'),
    ...
    url(r'^edit/purchaseReturnMaster/(?P<pk>.*)/$', views.edit_purchaseReturnMaster, name='edit_purchaseReturnMaster'),
