...
from api.v2.purchaseOrderMaster import views


urlpatterns = [
	url(r'^create-purchaseOrderMaster/$', views.create_purchaseOrderMaster, name='create_purchaseOrderMaster'),
    ...
    url(r'^edit/purchaseOrderMaster/(?P<pk>.*)/$', views.edit_purchaseOrderMaster, name='edit_purchaseOrderMaster'),
