...
from api.v2.salesOrderMaster import views


urlpatterns = [
	url(r'^create-salesOrderMaster/$', views.create_salesOrderMaster, name='create_salesOrderMaster'),
    ...
    url(r'^edit/salesOrderMaster/(?P<pk>.*)/$', views.edit_salesOrderMaster, name='edit_salesOrderMaster'),
