...
from brands.models import Activity_Log,VoucherNoTable, PaymentMaster, PaymentMaster_Log, PaymentDetails, PaymentDetails_Log, LedgerPosting, LedgerPosting_Log, PaymentDetailsDummy,\
    TransactionTypes, CompanySettings, GeneralSettings, AccountLedger
from rest_framework.renderers import JSONRenderer
from rest_framework.decorators import api_view, permission_classes, renderer_classes
from rest_framework.response import Response
from rest_framework.permissions import AllowAny, IsAuthenticated
from api.v8.payments.serializers import PaymentMasterSerializer, PaymentMasterRestSerializer, PaymentDetailsSerializer, PaymentDetailsRestSerializer
from api.v8.payments.serializers import ListSerializer
from api.v8.payments.functions import export_to_excel_paymentReport, generate_serializer_errors, paymentReport_excel_data
from rest_framework import status
from api.v8.payments.functions import get_auto_id, get_auto_idMaster, get_auto_VoucherNo
...
from api.v8.receipts.functions import get_voucher_type
            ...
            if is_PaymentsOK:
                ...
                for paymentsDetail in paymentsDetails:
                    ...
                    if float(Discount) > 0:
                        ...
                        update_ledger = UpdateLedgerBalance(
                            CompanyID, BranchID, 82, PaymentMasterID, VoucherType, Discount, "Cr", "create")
