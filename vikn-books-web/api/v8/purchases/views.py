...
from api.v8.purchases.serializers import PurchaseMasterSerializer, PurchaseMasterRestSerializer, PurchaseMasterRest1Serializer, PurchaseDetailsSerializer,\
...
from api.v8.purchases.functions import SetBatch,export_to_excel_purchase, export_to_excel_purchaseRetun, generate_serializer_errors, purchase_excel_data, purchase_gst_excel_data, export_to_excel_purchase_gst, purchaseReturn_excel_data
from rest_framework import status
from api.v8.sales.serializers import ListSerializerforReport
from api.v8.purchases.functions import purchase_taxgroup_excel_data, export_to_excel_purchase_taxgroup, get_auto_id, get_auto_idMaster, get_auto_StockRateID, get_auto_StockTransID
...
from api.v8.purchaseOrders.serializers import PurchaseOrderMasterRestSerializer
...
from api.v8.accountLedgers.functions import get_LedgerCode, get_auto_id as generated_ledgerID, UpdateLedgerBalance
import math
from main.functions import update_voucher_table,FormatedDate
            ...
            if is_PurchaseOK:
                ...
                if TaxType == 'VAT':
                    if float(VATAmount) > 0:
                        ...
                        update_ledger = UpdateLedgerBalance(
                            CompanyID, BranchID, 54, PurchaseMasterID, VoucherType, VATAmount, "Dr", "create")
                        ...
                        update_ledger = UpdateLedgerBalance(
                            CompanyID, BranchID, PurchaseAccount, PurchaseMasterID, VoucherType, VATAmount, "Cr", "create")
                    ...
                    if float(CGSTAmount) > 0:
                        ...
                        update_ledger = UpdateLedgerBalance(
                            CompanyID, BranchID, 36, PurchaseMasterID, VoucherType, CGSTAmount, "Dr", "create")
                        ...
                        update_ledger = UpdateLedgerBalance(
                            CompanyID, BranchID, PurchaseAccount, PurchaseMasterID, VoucherType, CGSTAmount, "Cr", "create")
                    ...
                    if float(SGSTAmount) > 0:
                        ...
                        update_ledger = UpdateLedgerBalance(
                            CompanyID, BranchID, 42, PurchaseMasterID, VoucherType, SGSTAmount, "Dr", "create")
                        ...
                        update_ledger = UpdateLedgerBalance(
                            CompanyID, BranchID, PurchaseAccount, PurchaseMasterID, VoucherType, SGSTAmount, "Cr", "create")
                    ...
                    if float(IGSTAmount) > 0:
                        ...
                        update_ledger = UpdateLedgerBalance(
                            CompanyID, BranchID, 39, PurchaseMasterID, VoucherType, IGSTAmount, "Dr", "create")
                        ...
                        update_ledger = UpdateLedgerBalance(
                            CompanyID, BranchID, PurchaseAccount, PurchaseMasterID, VoucherType, IGSTAmount, "Cr", "create")
                ...
                if not TaxType == 'Import':
                    if float(TAX1Amount) > 0:
                        ...
                        update_ledger = UpdateLedgerBalance(
                            CompanyID, BranchID, 45, PurchaseMasterID, VoucherType, TAX1Amount, "Dr", "create")
                        ...
                        update_ledger = UpdateLedgerBalance(
                            CompanyID, BranchID, PurchaseAccount, PurchaseMasterID, VoucherType, TAX1Amount, "Cr", "create")
                    ...
                    if float(TAX2Amount) > 0:
                        ...
                        update_ledger = UpdateLedgerBalance(
                            CompanyID, BranchID, 48, PurchaseMasterID, VoucherType, TAX2Amount, "Dr", "create")
                        ...
                        update_ledger = UpdateLedgerBalance(
                            CompanyID, BranchID, PurchaseAccount, PurchaseMasterID, VoucherType, TAX2Amount, "Cr", "create")
                    ...
                    if float(TAX3Amount) > 0:
                        ...
                        update_ledger = UpdateLedgerBalance(
                            CompanyID, BranchID, 51, PurchaseMasterID, VoucherType, TAX3Amount, "Dr", "create")
                        ...
                        update_ledger = UpdateLedgerBalance(
                            CompanyID, BranchID, PurchaseAccount, PurchaseMasterID, VoucherType, TAX3Amount, "Cr", "create")
                ...
                if float(RoundOff) > 0:
                    ...
                    update_ledger = UpdateLedgerBalance(
                        CompanyID, BranchID, 77, PurchaseMasterID, VoucherType, RoundOff, "Dr", "create")
                    ...
                    update_ledger = UpdateLedgerBalance(
                        CompanyID, BranchID, PurchaseAccount, PurchaseMasterID, VoucherType, RoundOff, "Cr", "create")
                ...
                if float(RoundOff) < 0:
                    ...
                    update_ledger = UpdateLedgerBalance(
                        CompanyID, BranchID, 77, PurchaseMasterID, VoucherType, RoundOff, "Cr", "create")
                    ...
                    update_ledger = UpdateLedgerBalance(
                        CompanyID, BranchID, PurchaseAccount, PurchaseMasterID, VoucherType, RoundOff, "Dr", "create")
                ...
                if float(TotalDiscount) > 0:
                    ...
                    update_ledger = UpdateLedgerBalance(
                        CompanyID, BranchID, 83, PurchaseMasterID, VoucherType, TotalDiscount, "Cr", "create")
                    ...
                    update_ledger = UpdateLedgerBalance(
                        CompanyID, BranchID, PurchaseAccount, PurchaseMasterID, VoucherType, TotalDiscount, "Dr", "create")
                ...
                if float(CashReceived) == 0 and float(BankAmount) == 0:
                    ...
                    update_ledger = UpdateLedgerBalance(
                        CompanyID, BranchID, PurchaseAccount, PurchaseMasterID, VoucherType, GrandTotal, "Dr", "create")
                    ...
                    update_ledger = UpdateLedgerBalance(
                        CompanyID, BranchID, LedgerID, PurchaseMasterID, VoucherType, GrandTotal, "Cr", "create")
                ...
                # customer with cash and customer with partial cash start here
                    ...
                    update_ledger = UpdateLedgerBalance(
                        CompanyID, BranchID, CashID, PurchaseMasterID, VoucherType, CashAmount, "Cr", "create")
                    ...
                    update_ledger = UpdateLedgerBalance(
                        CompanyID, BranchID, LedgerID, PurchaseMasterID, VoucherType, CashAmount, "Dr", "create")
                ...
                # customer with bank and customer with partial bank start here
                    ...
                    update_ledger = UpdateLedgerBalance(
                        CompanyID, BranchID, BankID, PurchaseMasterID, VoucherType, BankAmount, "Cr", "create")
                    ...
                    update_ledger = UpdateLedgerBalance(
                        CompanyID, BranchID, LedgerID, PurchaseMasterID, VoucherType, BankAmount, "Dr", "create")
                ...
                # bank with cash and cash with cash start here
                    ...
                    update_ledger = UpdateLedgerBalance(
                        CompanyID, BranchID, PurchaseAccount, PurchaseMasterID, VoucherType, CashAmount, "Dr", "create")
                    ...
                    if not float(csh_value) == 0:
                        ...
                        update_ledger = UpdateLedgerBalance(
                            CompanyID, BranchID, LedgerID, PurchaseMasterID, VoucherType, csh_value, "Cr", "create")
                        ...
                        update_ledger = UpdateLedgerBalance(
                            CompanyID, BranchID, PurchaseAccount, PurchaseMasterID, VoucherType, csh_value, "Dr", "create")
                ...
                # bank with bank and cash with bank start here
                    ...
                    update_ledger = UpdateLedgerBalance(
                        CompanyID, BranchID, PurchaseAccount, PurchaseMasterID, VoucherType, BankAmount, "Dr", "create")
                    ...
                    if not float(bnk_value) == 0:
                        ...
                        update_ledger = UpdateLedgerBalance(
                            CompanyID, BranchID, LedgerID, PurchaseMasterID, VoucherType, bnk_value, "Cr", "create")
                        ...
                        update_ledger = UpdateLedgerBalance(
                            CompanyID, BranchID, PurchaseAccount, PurchaseMasterID, VoucherType, bnk_value, "Dr", "create")
                ...
                # cash with cash/bank start here
                    ...
                    if not float(Balance_amt) == 0:
                        ...
                        update_ledger = UpdateLedgerBalance(
                            CompanyID, BranchID, PurchaseAccount, PurchaseMasterID, VoucherType, Balance_amt, "Dr", "create")
                        ...
                        update_ledger = UpdateLedgerBalance(
                            CompanyID, BranchID, LedgerID, PurchaseMasterID, VoucherType, Balance_amt, "Cr", "create")
                    ...
                    update_ledger = UpdateLedgerBalance(
                        CompanyID, BranchID, PurchaseAccount, PurchaseMasterID, VoucherType, CashReceived, "Dr", "create")
                    ...
                    update_ledger = UpdateLedgerBalance(
                        CompanyID, BranchID, CashID, PurchaseMasterID, VoucherType, CashReceived, "Cr", "create")
                        ...
                        if product_is_Service == False:
                            if GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID, SettingsType="EnableProductBatchWise").exists():
                                ...
                                if check_EnableProductBatchWise == "True" or check_EnableProductBatchWise == True:
                                    BatchCode,message = SetBatch(CompanyID, check_EnableProductBatchWise, check_BatchCriteria, BranchID, ProductID, PriceListID,SalesPrice,Batch_purchasePrice,
                                                        ExpiryDate,ManufactureDate,Qty_batch,WarehouseID,today,CreatedUserID,BatchCode,"create","PI")
    ...
    try:
        with transaction.atomic():
            ...
            if PurchaseDetails.objects.filter(CompanyID=CompanyID, BranchID=BranchID, PurchaseMasterID=PurchaseMasterID).exists():
                ...
                for i in purch_ins:
                    ...
                    if Batch.objects.filter(CompanyID=CompanyID, BranchID=BranchID, BatchCode=BatchCode).exists():
                        ...
                        StockIn = batch_ins.StockIn
                        batch_ins.StockIn = float(StockIn) - float(instance_Qty)
                        batch_ins.save()
                    ...
                    if StockPosting.objects.filter(CompanyID=CompanyID, VoucherMasterID=PurchaseMasterID, VoucherDetailID=i.PurchaseDetailsID, ProductID=i.ProductID, BranchID=BranchID, VoucherType="PI").exists():
                        stock_inst = StockPosting.objects.filter(CompanyID=CompanyID, VoucherMasterID=PurchaseMasterID,
                                                                 VoucherDetailID=i.PurchaseDetailsID, ProductID=i.ProductID, BranchID=BranchID, VoucherType="PI").first()
                        stock_inst.QtyIn = float(
                            stock_inst.QtyIn) - float(instance_Qty)
                        stock_inst.save()
                        update_stock(CompanyID, BranchID, i.ProductID)
            ...
            # customer with partial cash /bank and customer with cash/bank
                ...
                update_ledger = UpdateLedgerBalance(
                    CompanyID, BranchID, BankID, PurchaseMasterID, VoucherType, BankAmount, "Dr", "create")
            # customer with partial cash /bank and customer with cash/bank
                    ...
                    if PriceList.objects.filter(CompanyID=CompanyID, ProductID=ProductID_Deleted, DefaultUnit=True).exists():
                        ...
                        if not deleted_pk == '' or not deleted_pk == 0:
                            if PurchaseDetails.objects.filter(CompanyID=CompanyID, pk=deleted_pk).exists():
                                ...
                                deleted_batch = Batch.objects.filter(CompanyID=CompanyID,BranchID=BranchID,BatchCode=deleted_BatchCode).first()
                                if not StockPosting.objects.filter(CompanyID=CompanyID,BranchID=BranchID,BatchID=deleted_BatchCode).exclude(VoucherType="PI").exists():
                                    ...
                                    qty_batch = float(deleted_detail.FreeQty) + float(deleted_detail.Qty)
                                    Qty_batch = float(MultiFactor) * float(qty_batch)
                                ...
                                if StockPosting.objects.filter(CompanyID=CompanyID, VoucherMasterID=PurchaseMasterID_Deleted, VoucherDetailID=PurchaseDetailsID_Deleted, ProductID=ProductID_Deleted, BranchID=BranchID, VoucherType="PI").exists():
                                    stock_instances_delete = StockPosting.objects.filter(
                                        CompanyID=CompanyID, VoucherMasterID=PurchaseMasterID_Deleted, VoucherDetailID=PurchaseDetailsID_Deleted, ProductID=ProductID_Deleted, BranchID=BranchID, VoucherType="PI")
                ...
                if ProductID:
                    ...
                    if product_is_Service == False:
                        if GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID, SettingsType="EnableProductBatchWise").exists():
                            ...
                            BatchCode,message = SetBatch(CompanyID, check_EnableProductBatchWise, check_BatchCriteria, BranchID, ProductID, PriceListID,SalesPrice,Batch_purchasePrice,
                                                ExpiryDate,ManufactureDate,Qty_batch,WarehouseID,today,CreatedUserID,BatchCode,"update","PI")
                    ...
                    if detailID == 0:
                        ...
                        if product_is_Service == False:
                            if StockPosting.objects.filter(CompanyID=CompanyID, WareHouseID=WarehouseID, VoucherMasterID=PurchaseMasterID, VoucherDetailID=PurchaseDetailsID, BranchID=BranchID, VoucherType="PI", ProductID=ProductID).exists():
                                stock_instance = StockPosting.objects.filter(CompanyID=CompanyID, WareHouseID=WarehouseID, VoucherMasterID=PurchaseMasterID,
                                                                             VoucherDetailID=PurchaseDetailsID, BranchID=BranchID, VoucherType="PI", ProductID=ProductID).first()
...
def delete_purchaseMaster(request, pk):
    ...
    if selecte_ids:
        if PurchaseMaster.objects.filter(CompanyID=CompanyID, pk__in=selecte_ids).exists():
            ...
            for detail_instance in detail_instances:
                ...
                if CompanyID.business_type.Name == "Pharmacy":
                    if not StockPosting.objects.filter(CompanyID=CompanyID,BranchID=BranchID,BatchID=BatchCode).exclude(VoucherType="PI").exists():
                        if Batch.objects.filter(CompanyID=CompanyID, BranchID=BranchID, BatchCode=BatchCode).exists():
                            Batch.objects.filter(CompanyID=CompanyID, BranchID=BranchID, BatchCode=BatchCode).delete()
                    else:
                        MultiFactor = PriceList.objects.get(
                            CompanyID=CompanyID, PriceListID=PriceListID, BranchID=BranchID).MultiFactor
    ...
    if serialized1.is_valid():
        ...
        if ReffNo:
            if PurchaseMaster.objects.filter(CompanyID=CompanyID, BranchID=BranchID, Date__gte=FromDate, Date__lte=ToDate, RefferenceBillNo=ReffNo).exists():
                ...
                serialized_purchase = PurchaseMasterRestSerializer(purchase_sort_pagination, many=True, context={
        ...
        if purchase_data or purchaseReturn_data:
            ...
            count_divided_purchase_return = math.ceil(
                float(count_purchase_return) / 10)
            length = 0
            if instances:
...
def report_purchases(request):
    ...
    if serialized1.is_valid():
        ...
        #     serialized_purchaseReturn = PurchaseReturnMasterRestSerializer(
        #         purchase_return_sort_pagination, many=True, context={"CompanyID": CompanyID, "PriceRounding": PriceRounding})
        #     purchaseReturn_data = serialized_purchaseReturn.data
        #     PurchaseReturnCode = 6000
        ...
        if Product.objects.filter(CompanyID=CompanyID, BranchID=BranchID).exists():
            ...
            if not ProductCode.isdecimal():
                ...
                if temp.match(ProductCode):
                    ...
                    ProductCode = str(int(ProductCodeNumber) + 1).zfill(len(ProductCodeNumber))
        ...
        for tx in tax_types:
            if PurchaseMaster.objects.filter(CompanyID=CompanyID, BranchID=BranchID, Date__gte=FromDate, Date__lte=ToDate, TaxType=tx).exists():
                ...
                purchase_details = PurchaseDetails.objects.filter(
                    CompanyID=CompanyID, BranchID=BranchID, PurchaseMasterID__in=purchase_ids).exclude(IGSTPerc=0)
                    ...
                    if gouprd_details:
                        ...
                        for g in gouprd_details:
                            ...
                            Date = purchase_instances.get(
                                PurchaseMasterID=PurchaseMasterID).Date
                            InvoiceNo = purchase_instances.get(
                                PurchaseMasterID=PurchaseMasterID).RefferenceBillNo
                            LedgerID = purchase_instances.get(
                                PurchaseMasterID=PurchaseMasterID).LedgerID
...
def search_purchase_list(request):
    ...
    if serialized1.is_valid():
        ...
        if PurchaseMaster.objects.filter(CompanyID=CompanyID, BranchID=BranchID).exists():
            ...
            serialized = PurchaseMasterRest1Serializer(instances, many=True, context={
...
def purchase_report_excel(request):
    ...
    if Type == '1':
        ...
        response['Content-Disposition'] = 'attachment; filename="Purchase Return Report.xls"'
