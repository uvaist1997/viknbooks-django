...
from brands.models import CompanySettings, FinancialYear, Country, State, BusinessType, Edition
...
class CompanySettingsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'Action', 'CompanyName', 'Address1', 'Address2', 'Address3', 'City', 'State', 'Country', 'PostalCode',
                  'Phone', 'Mobile', 'Website', 'VATNumber', 'GSTNumber', 'Tax1', 'Tax2', 'Tax3', 'CRNumber', "CINNumber", 'Description', "is_vat", "is_gst", "RegistrationType")
...
class CompanySettingsInitialSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CompanySettings
        fields = ('id', 'Action', 'CompanyName', 'State', 'Country', 'GSTNumber', 'VATNumber', 'business_type',
                  'is_vat', 'is_gst', 'Edition', 'Email', 'Phone', 'Address1', 'Address2', 'City', 'PostalCode')
