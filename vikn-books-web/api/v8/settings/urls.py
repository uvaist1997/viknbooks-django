...
from api.v8.settings import views


app_name = 'api.v8.settings.urls'
...
urlpatterns = [
    ...
    url(r'^view/settings/(?P<pk>.*)/$',
        views.document_settings, name='document_settings'),
    ...
    url(r'^print-settings-list/$', views.print_settings_list,
        name='print_settings_list'),

    url(r'^print-report-paper/$', views.print_report_paper,
        name='print_report_paper'),

     url(r'^user-role/settings-update/$', views.user_role_settings_update, name='user_role_settings_update'),
