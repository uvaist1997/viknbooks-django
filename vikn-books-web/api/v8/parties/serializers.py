...
class PartiesRestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'PartyID', 'BranchID', 'PartyType', 'LedgerID', 'PartyCode', 'FirstName', 'LastName', 'PartyName', 'DisplayName', 'Address1', 'Address2', 'City', 'State', 'Attention', 'CountryName', 'StateName', 'Country_ShippingName', 'State_ShippingName',
                  ...
                  'District','AdditionalNo','District_shipping','AdditionalNo_shipping')
    ...
    def get_BankDetails(self, instances):
        ...
        if PartyBankDetails.objects.filter(CompanyID=CompanyID, Branch__BranchID=BranchID, Party=instances).exists():
            BankDetails = PartyBankDetails.objects.filter(CompanyID=CompanyID, Branch__BranchID=BranchID, Party=instances)
...
class PartyBankDetailsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id','CompanyID','Branch','Party','BankName1','AccountName1','AccountNo1','IBANOrIFSCCode1','detailID')
