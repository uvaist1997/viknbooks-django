...
from api.v8.damageStock.serializers import DamageStockMasterRestSerializer, DamageStockDetailsRestSerializer
...
from api.v8.damageStock.functions import get_auto_id, get_auto_idMaster
