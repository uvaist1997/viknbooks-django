from brands.models import QrCode,VoucherNoTable,PurchaseReturnMaster, PurchaseReturnMaster_Log, PurchaseReturnDetails, PurchaseReturnDetails_Log,\
...
from api.v8.purchaseReturns.serializers import PurchaseReturnMasterSerializer,PurchaseReturn1MasterRestSerializer, PurchaseReturnMasterRestSerializer, PurchaseReturnDetailsSerializer, PurchaseReturnDetailsRestSerializer
from api.v8.brands.serializers import ListSerializer
from api.v8.purchaseReturns.functions import generate_serializer_errors
from rest_framework import status
from api.v8.sales.serializers import ListSerializerforReport
from api.v8.purchaseReturns.functions import get_auto_id, get_auto_idMaster
from api.v8.sales.functions import get_auto_stockPostid,SetBatchInSales
from api.v8.accountLedgers.functions import get_auto_LedgerPostid,UpdateLedgerBalance
    ...
    try:
        with transaction.atomic():
            ...
            if is_PurchaseReturnOK:
                ...
                invoice_date = purchase_instance.CreatedDate.strftime("%d-%b-%y %I:%M:%S %p")
                fatoora_obj = Fatoora(
                ...
                update_ledger = UpdateLedgerBalance(CompanyID,BranchID,PurchaseAccount,PurchaseReturnMasterID,VoucherType,GrandTotal,"Cr","create")
                ...
                update_ledger = UpdateLedgerBalance(CompanyID,BranchID,LedgerID,PurchaseReturnMasterID,VoucherType,GrandTotal,"Dr","create")
                ...
                if TaxType == 'VAT':
                    if float(VATAmount) > 0:
                        ...
                        update_ledger = UpdateLedgerBalance(CompanyID,BranchID,54,PurchaseReturnMasterID,VoucherType,VATAmount,"Cr","create")
                        ...
                        update_ledger = UpdateLedgerBalance(CompanyID,BranchID,PurchaseAccount,PurchaseReturnMasterID,VoucherType,VATAmount,"Dr","create")
                    ...
                    if float(CGSTAmount) > 0:
                        ...
                        update_ledger = UpdateLedgerBalance(CompanyID,BranchID,36,PurchaseReturnMasterID,VoucherType,CGSTAmount,"Cr","create")
                        ...
                        update_ledger = UpdateLedgerBalance(CompanyID,BranchID,PurchaseAccount,PurchaseReturnMasterID,VoucherType,CGSTAmount,"Dr","create")
                    ...
                    if float(SGSTAmount) > 0:
                        ...
                        update_ledger = UpdateLedgerBalance(CompanyID,BranchID,42,PurchaseReturnMasterID,VoucherType,SGSTAmount,"Cr","create")
                        ...
                        update_ledger = UpdateLedgerBalance(CompanyID,BranchID,PurchaseAccount,PurchaseReturnMasterID,VoucherType,SGSTAmount,"Dr","create")
                    ...
                    if float(IGSTAmount) > 0:
                        ...
                        update_ledger = UpdateLedgerBalance(CompanyID,BranchID,39,PurchaseReturnMasterID,VoucherType,IGSTAmount,"Cr","create")
                        ...
                        update_ledger = UpdateLedgerBalance(CompanyID,BranchID,PurchaseAccount,PurchaseReturnMasterID,VoucherType,IGSTAmount,"Dr","create")
                ...
                if not TaxType == 'Import':
                    if float(TAX1Amount) > 0:
                        ...
                        update_ledger = UpdateLedgerBalance(CompanyID,BranchID,45,PurchaseReturnMasterID,VoucherType,TAX1Amount,"Cr","create")
                        ...
                        update_ledger = UpdateLedgerBalance(CompanyID,BranchID,PurchaseAccount,PurchaseReturnMasterID,VoucherType,TAX1Amount,"Dr","create")
                    ...
                    if float(TAX2Amount) > 0:
                        ...
                        update_ledger = UpdateLedgerBalance(CompanyID,BranchID,48,PurchaseReturnMasterID,VoucherType,TAX2Amount,"Cr","create")
                        ...
                        update_ledger = UpdateLedgerBalance(CompanyID,BranchID,PurchaseAccount,PurchaseReturnMasterID,VoucherType,TAX2Amount,"Dr","create")
                    ...
                    if float(TAX3Amount) > 0:
                        ...
                        update_ledger = UpdateLedgerBalance(CompanyID,BranchID,51,PurchaseReturnMasterID,VoucherType,TAX3Amount,"Cr","create")
                        ...
                        update_ledger = UpdateLedgerBalance(CompanyID,BranchID,PurchaseAccount,PurchaseReturnMasterID,VoucherType,TAX3Amount,"Dr","create")
                ...
                if float(RoundOff) > 0:
                    ...
                    update_ledger = UpdateLedgerBalance(CompanyID,BranchID,77,PurchaseReturnMasterID,VoucherType,RoundOff,"Cr","create")
                    ...
                    update_ledger = UpdateLedgerBalance(CompanyID,BranchID,PurchaseAccount,PurchaseReturnMasterID,VoucherType,RoundOff,"Dr","create")
                ...
                if float(RoundOff) < 0:
                    ...
                    update_ledger = UpdateLedgerBalance(CompanyID,BranchID,77,PurchaseReturnMasterID,VoucherType,RoundOff,"Dr","create")
                    ...
                    update_ledger = UpdateLedgerBalance(CompanyID,BranchID,PurchaseAccount,PurchaseReturnMasterID,VoucherType,RoundOff,"Cr","create")
                ...
                if float(TotalDiscount) > 0:
                    ...
                    update_ledger = UpdateLedgerBalance(CompanyID,BranchID,83,PurchaseReturnMasterID,VoucherType,TotalDiscount,"Dr","create")
                    ...
                    update_ledger = UpdateLedgerBalance(CompanyID,BranchID,PurchaseAccount,PurchaseReturnMasterID,VoucherType,TotalDiscount,"Cr","create")
...
def edit_purchaseReturn(request, pk):
    try:
        with transaction.atomic():
            ...
            update_ledger = UpdateLedgerBalance(CompanyID,BranchID,0,PurchaseReturnMasterID,"PR",0,"Cr","update")
            ...
            if PurchaseReturnDetails.objects.filter(CompanyID=CompanyID, BranchID=BranchID, PurchaseReturnMasterID=PurchaseReturnMasterID).exists():
                ...
                for i in returns_ins:
                    ...
                    if Batch.objects.filter(CompanyID=CompanyID, BranchID=BranchID, BatchCode=BatchCode).exists():
                        ...
                        StockOut = batch_ins.StockOut
                        batch_ins.StockOut = float(StockOut) - float(instance_Qty)
                        batch_ins.save()
                    ...
                    if not StockPosting.objects.filter(CompanyID=CompanyID, VoucherMasterID=PurchaseReturnMasterID,VoucherDetailID=i.PurchaseReturnDetailsID,BranchID=BranchID, VoucherType="PR").exists():
                        StockPosting.objects.filter(CompanyID=CompanyID, VoucherMasterID=PurchaseReturnMasterID,BranchID=BranchID, VoucherType="PR").delete()
                    ...
                    if StockPosting.objects.filter(CompanyID=CompanyID, VoucherMasterID=PurchaseReturnMasterID,VoucherDetailID=i.PurchaseReturnDetailsID,ProductID=i.ProductID,BranchID=BranchID, VoucherType="PR").exists():
                        stock_inst = StockPosting.objects.filter(CompanyID=CompanyID, VoucherMasterID=PurchaseReturnMasterID,VoucherDetailID=i.PurchaseReturnDetailsID,ProductID=i.ProductID,BranchID=BranchID, VoucherType="PR").first()
                        ...
                        if not deleted_pk == '' or not deleted_pk == 0:
                            if PurchaseReturnDetails.objects.filter(CompanyID=CompanyID, pk=deleted_pk).exists():
                                ...
                                if StockPosting.objects.filter(CompanyID=CompanyID, VoucherMasterID=PurchaseReturnMasterID_Deleted,VoucherDetailID=PurchaseReturnDetailsID_Deleted,ProductID=ProductID_Deleted,BranchID=BranchID, VoucherType="PR").exists():
                                    stock_instances_delete = StockPosting.objects.filter(CompanyID=CompanyID, VoucherMasterID=PurchaseReturnMasterID_Deleted,VoucherDetailID=PurchaseReturnDetailsID_Deleted,ProductID=ProductID_Deleted,BranchID=BranchID, VoucherType="PR")
                    ...
                    if detailID == 0:
                        ...
                        if product_is_Service == False:
                            if StockPosting.objects.filter(CompanyID=CompanyID,WareHouseID=WarehouseID, VoucherMasterID=PurchaseReturnMasterID,VoucherDetailID=PurchaseReturnDetailsID,BranchID=BranchID, VoucherType="PR",ProductID=ProductID).exists():
                                stock_instance = StockPosting.objects.filter(CompanyID=CompanyID,WareHouseID=WarehouseID, VoucherMasterID=PurchaseReturnMasterID,VoucherDetailID=PurchaseReturnDetailsID,BranchID=BranchID, VoucherType="PR",ProductID=ProductID).first()
