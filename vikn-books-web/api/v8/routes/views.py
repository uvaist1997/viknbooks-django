...
from api.v8.routes.serializers import RouteSerializer, RouteRestSerializer
from api.v8.brands.serializers import ListSerializer
from api.v8.routes.functions import generate_serializer_errors
from rest_framework import status
from api.v8.routes.functions import get_auto_id
import datetime
    ...
    if serialized1.is_valid():
        ...
        if Route.objects.filter(CompanyID=CompanyID, BranchID=BranchID).exists():
            ...
            if page_number and items_per_page:
                instances = Route.objects.filter(
                ...
                ledger_sort_pagination = Route.objects.filter(
                    CompanyID=CompanyID, BranchID=BranchID)
