...
class Batch_ListSerializer(serializers.ModelSerializer):
    ...
    def get_ProductGroupName(self, batch_details):
        ...
        ProductGroupName = ""
        if Product.objects.filter(CompanyID=CompanyID,BranchID=BranchID,ProductID=ProductID).exists():
            ProductGroupID = Product.objects.get(CompanyID=CompanyID,BranchID=BranchID,ProductID=ProductID).ProductGroupID
            if ProductGroup.objects.filter(CompanyID=CompanyID,BranchID=BranchID,ProductGroupID=ProductGroupID).exists():
                ProductGroupName = ProductGroup.objects.get(CompanyID=CompanyID,BranchID=BranchID,ProductGroupID=ProductGroupID).GroupName
    ...
    def get_base_unit(self, batch_details):
        ...
        if PriceList.objects.filter(CompanyID=CompanyID,BranchID=BranchID,ProductID=ProductID,DefaultUnit=True).exists():
            UnitID = PriceList.objects.get(CompanyID=CompanyID,BranchID=BranchID,ProductID=ProductID,DefaultUnit=True).UnitID
