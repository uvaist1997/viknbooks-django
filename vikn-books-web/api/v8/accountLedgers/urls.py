...
from api.v8.accountLedgers import views
...
urlpatterns = [
    ...
    url(r'^ledgerListforPayments-all/$', views.ledgerListforPayments_all,
    ...
    url(r'^search-ledgers/$',
        views.search_ledgers, name='search_ledgers'),

    url(r'^ledgerListByGroups/$', views.ledgerListByGroups,
        name='ledgerListByGroups'),

    url(r'^search-accountLedgers/$', views.search_accountLedgers,
