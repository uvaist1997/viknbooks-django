...
class PurchaseOrderMasterSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id','BranchID','VoucherNo','InvoiceNo','OrderNo','Date',
            ...
            'RoundOff','CashAmount','BankAmount','WarehouseID','IsActive','CreatedDate','CreatedUserID','BillDiscPercent','BillDiscAmt')
...
class PurchaseOrderMasterRestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id','PurchaseOrderMasterID','BranchID','Action','VoucherNo','InvoiceNo','OrderNo','Date',
            ...
            'AdditionalCost','BillDiscount','GrandTotal','RoundOff','CashAmount','BankAmount','WarehouseID','IsActive','CreatedDate','CreatedUserID','BillDiscPercent','BillDiscAmt')
