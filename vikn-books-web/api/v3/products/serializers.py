...
from brands.models import Product, PriceList, Brand, ProductGroup, TaxCategory, Unit, StockPosting, Batch, GeneralSettings
from api.v3.priceLists.serializers import PriceListRestSerializer, SinglePriceListRestSerializer
from api.v3.workOrder.serializers import Batch_ListSerializer, UnitListSerializer
...
class ProductRestSerializer(serializers.ModelSerializer):
    ...
    def get_ProductGroupName(self, instances):
        ...
        BranchID = instances.BranchID
        ProductGroupName = ""
        if ProductGroup.objects.filter(CompanyID=CompanyID, ProductGroupID=ProductGroupID, BranchID=BranchID).exists():
...
class BarCodeSearchSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'ProductID', 'BranchID',
                  'ProductName', 'PriceListID', 'UnitPrice', 'Stock', 'BatchCode')
