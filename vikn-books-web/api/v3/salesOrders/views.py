...
from api.v3.salesOrders.serializers import SalesOrderMasterSerializer, SalesOrderMasterRestSerializer, SalesOrderDetailsSerializer, SalesOrderDetailsRestSerializer
from api.v3.brands.serializers import ListSerializer
from api.v3.salesOrders.functions import generate_serializer_errors
from rest_framework import status
from api.v3.salesOrders.functions import get_auto_id, get_auto_idMaster
import datetime
...
def edit_salesOrder(request, pk):
    ...
    salesOrderMaster_instance = SalesOrderMaster.objects.get(CompanyID=CompanyID,pk=pk)
    ...
    for salesOrderDetail in salesOrderDetails:
        ...
        if ProductID:
            ...
            if detailID == 0:
                Action = "M"
                salesDetail_instance = SalesOrderDetails.objects.get(CompanyID=CompanyID, pk=unq_id)
