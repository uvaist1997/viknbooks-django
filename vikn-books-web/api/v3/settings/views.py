...
from api.v3.settings import serializers
from api.v3.brands.serializers import ListSerializer
from api.v3.settings.functions import generate_serializer_errors
from rest_framework import status
from api.v3.settings.functions import get_auto_id
...
def user_type_settings_list(request):
    ...
    if models.UserTypeSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID).exists():
        ...
        # return HttpResponse(reverse('api_v3_settings:user_type_settings_list'))
        response_data = {
            "StatusCode": 6000,
            "message": "success"
        }
