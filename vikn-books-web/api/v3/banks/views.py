...
from api.v3.banks.serializers import BankSerializer, BankRestSerializer
from api.v3.brands.serializers import ListSerializer
from api.v3.banks.functions import generate_serializer_errors
from rest_framework import status
from api.v3.banks.functions import get_auto_Bankid, get_BankCode
from api.v3.accountLedgers.functions import get_auto_id, get_auto_LedgerPostid
import datetime
...
def banks(request):
    ...
    if serialized1.is_valid():
        ...
        if Bank.objects.filter(BranchID=BranchID, CompanyID=CompanyID).exists():
            ...
            serialized = BankRestSerializer(instances, many=True, context={
