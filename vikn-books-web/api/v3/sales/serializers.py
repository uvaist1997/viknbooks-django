...
from brands.models import SalesMaster, SalesDetails, Product, AccountLedger, Warehouse, PriceList, TransactionTypes, Unit, TaxCategory, StockPosting, StockRate, LedgerPosting, Parties, Batch
...
class BatchSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Batch
        fields = ('id','BatchCode','CompanyID','ProductName','Stock','BranchID','ManufactureDate','ExpiryDate','BatchCode','StockIn','StockOut','PurchasePrice','SalesPrice','PriceListID','ProductID','WareHouseID','WareHouseName')


    def get_ManufactureDate(self, instance):
        date = ""
        if instance.ManufactureDate:
            date = instance.ManufactureDate.date()
    ...
    def get_Stock(self, instance):
        stock = float(instance.StockIn) - float(instance.StockOut)
