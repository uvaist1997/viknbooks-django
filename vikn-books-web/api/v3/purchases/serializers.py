...
class PurchaseDetailsRestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'unq_id', 'PurchaseDetailsID', 'BranchID', 'Action', 'PurchaseMasterID', 'ProductID', 'ProductName', 'Qty', 'FreeQty',
                  'UnitPrice', 'InclusivePrice', 'RateWithTax', 'CostPerItem','ManufactureDate','ExpiryDate',
                  ...
                  'unitPriceRounded', 'quantityRounded', 'actualPurchasePrice', 'netAmountRounded','BatchCode','ManufactureDate','ExpiryDate')
