from brands.models import UserTable, User_Log, UserType, CompanySettings, SoftwareVersion, SoftwareVersionLog
...
from django.contrib.auth.models import User, Group
from api.v3.users.functions import get_auto_id
from brands import models
from api.v3.general.functions import get_current_role
...
from api.v3.users.functions import send_email
...
from api.v3.users.serializers import CustomTokenSerializer, SoftwareVersionSerializer
...
def create_general_settings(request):
    ...
    if serialized.is_valid():
        ...
        Free_Quantity_In_Purchase = str(
            serialized.data['Free_Quantity_In_Purchase'])
...
def general_settings_list(request):
    ...
    if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID).exists():
        ...
        check_Purchase_GST_Type = administrations_models.GeneralSettings.objects.get(
            CompanyID=CompanyID, BranchID=BranchID, SettingsType="Purchase_GST_Type").SettingsValue
        check_Sales_GST_Type = administrations_models.GeneralSettings.objects.get(
            CompanyID=CompanyID, BranchID=BranchID, SettingsType="Sales_GST_Type").SettingsValue
        check_Sales_VAT_Type = administrations_models.GeneralSettings.objects.get(
            CompanyID=CompanyID, BranchID=BranchID, SettingsType="Sales_VAT_Type").SettingsValue
        check_Purchase_VAT_Type = administrations_models.GeneralSettings.objects.get(
            CompanyID=CompanyID, BranchID=BranchID, SettingsType="Purchase_VAT_Type").SettingsValue
        check_Free_Quantity_In_Sales = administrations_models.GeneralSettings.objects.get(
            CompanyID=CompanyID, BranchID=BranchID, SettingsType="Free_Quantity_In_Sales").SettingsValue
        check_Free_Quantity_In_Purchase = administrations_models.GeneralSettings.objects.get(
            CompanyID=CompanyID, BranchID=BranchID, SettingsType="Free_Quantity_In_Purchase").SettingsValue
        check_Show_Sales_Type = administrations_models.GeneralSettings.objects.get(
            CompanyID=CompanyID, BranchID=BranchID, SettingsType="Show_Sales_Type").SettingsValue
        check_Show_Purchase_Type = administrations_models.GeneralSettings.objects.get(
            CompanyID=CompanyID, BranchID=BranchID, SettingsType="Show_Purchase_Type").SettingsValue
        check_VAT = administrations_models.GeneralSettings.objects.get(
            CompanyID=CompanyID, BranchID=BranchID, SettingsType="VAT").SettingsValue
        check_GST = administrations_models.GeneralSettings.objects.get(
            CompanyID=CompanyID, BranchID=BranchID, SettingsType="GST").SettingsValue
        check_TAX1 = administrations_models.GeneralSettings.objects.get(
            CompanyID=CompanyID, BranchID=BranchID, SettingsType="TAX1").SettingsValue
        check_TAX2 = administrations_models.GeneralSettings.objects.get(
            CompanyID=CompanyID, BranchID=BranchID, SettingsType="TAX2").SettingsValue
        check_TAX3 = administrations_models.GeneralSettings.objects.get(
            CompanyID=CompanyID, BranchID=BranchID, SettingsType="TAX3").SettingsValue
        check_Trading = administrations_models.GeneralSettings.objects.get(
            CompanyID=CompanyID, BranchID=BranchID, SettingsType="Trading").SettingsValue
        check_Restaurant = administrations_models.GeneralSettings.objects.get(
            CompanyID=CompanyID, BranchID=BranchID, SettingsType="Restaurant").SettingsValue
        check_QtyDecimalPoint = administrations_models.GeneralSettings.objects.get(
            CompanyID=CompanyID, BranchID=BranchID, SettingsType="QtyDecimalPoint").SettingsValue
        check_PriceDecimalPoint = administrations_models.GeneralSettings.objects.get(
            CompanyID=CompanyID, BranchID=BranchID, SettingsType="PriceDecimalPoint").SettingsValue

        if administrations_models.GeneralSettings.objects.filter(
                CompanyID=CompanyID, BranchID=BranchID, SettingsType="PreDateTransaction").exists():
            check_PreDateTransaction = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, BranchID=BranchID, SettingsType="PreDateTransaction").SettingsValue
        if administrations_models.GeneralSettings.objects.filter(
                CompanyID=CompanyID, BranchID=BranchID, SettingsType="PostDateTransaction").exists():
            check_PostDateTransaction = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, BranchID=BranchID, SettingsType="PostDateTransaction").SettingsValue
        check_Additional_Discount = administrations_models.GeneralSettings.objects.get(
            CompanyID=CompanyID, BranchID=BranchID, SettingsType="Additional_Discount").SettingsValue
        check_Bill_Discount = administrations_models.GeneralSettings.objects.get(
            CompanyID=CompanyID, BranchID=BranchID, SettingsType="Bill_Discount").SettingsValue
        check_Negatine_Stock = administrations_models.GeneralSettings.objects.get(
            CompanyID=CompanyID, BranchID=BranchID, SettingsType="Negatine_Stock").SettingsValue
        check_Increment_Qty_In_POS = administrations_models.GeneralSettings.objects.get(
            CompanyID=CompanyID, BranchID=BranchID, SettingsType="Increment_Qty_In_POS").SettingsValue
        check_Kitchen_Print = administrations_models.GeneralSettings.objects.get(
            CompanyID=CompanyID, BranchID=BranchID, SettingsType="Kitchen_Print").SettingsValue
        check_Order_Print = administrations_models.GeneralSettings.objects.get(
            CompanyID=CompanyID, BranchID=BranchID, SettingsType="Order_Print").SettingsValue
        check_Print_After_Save_Active = administrations_models.GeneralSettings.objects.get(
            CompanyID=CompanyID, BranchID=BranchID, SettingsType="Print_After_Save_Active").SettingsValue
        QtyDecimalPoint = administrations_models.GeneralSettings.objects.get(
            CompanyID=CompanyID, BranchID=BranchID, SettingsType="QtyDecimalPoint").SettingsValue
        ...
        RoundingFigure = administrations_models.GeneralSettings.objects.get(
            CompanyID=CompanyID, BranchID=BranchID, SettingsType="RoundingFigure").SettingsValue
        ...
        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID, SettingsType="MultiUnit").exists():
            MultiUnit = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, BranchID=BranchID, SettingsType="MultiUnit").SettingsValue
            if MultiUnit == "True":
                MultiUnit = True
            else:
                MultiUnit = False

        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID, SettingsType="AllowNegativeStockSales").exists():
            AllowNegativeStockSales = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, BranchID=BranchID, SettingsType="AllowNegativeStockSales").SettingsValue
            if AllowNegativeStockSales == "True":
                AllowNegativeStockSales = True
            else:
                AllowNegativeStockSales = False

        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID, SettingsType="PriceCategory").exists():
            PriceCategory = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, BranchID=BranchID, SettingsType="PriceCategory").SettingsValue
            if PriceCategory == "True":
                PriceCategory = True
            else:
                PriceCategory = False

        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID, SettingsType="InclusiveRateSales").exists():
            InclusiveRateSales = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, BranchID=BranchID, SettingsType="InclusiveRateSales").SettingsValue
            if InclusiveRateSales == "True":
                InclusiveRateSales = True
            else:
                InclusiveRateSales = False

        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID, SettingsType="InclusiveRatePurchase").exists():
            InclusiveRatePurchase = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, BranchID=BranchID, SettingsType="InclusiveRatePurchase").SettingsValue
            if InclusiveRatePurchase == "True":
                InclusiveRatePurchase = True
            else:
                InclusiveRatePurchase = False

        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID, SettingsType="InclusiveRateWorkOrder").exists():
            InclusiveRateWorkOrder = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, BranchID=BranchID, SettingsType="InclusiveRateWorkOrder").SettingsValue
            if InclusiveRateWorkOrder == "True":
                InclusiveRateWorkOrder = True
            else:
                InclusiveRateWorkOrder = False

        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID, SettingsType="ShowDiscountInSales").exists():
            ShowDiscountInSales = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, BranchID=BranchID, SettingsType="ShowDiscountInSales").SettingsValue
            if ShowDiscountInSales == "True":
                ShowDiscountInSales = True
            else:
                ShowDiscountInSales = False

        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID, SettingsType="ShowManDateAndExpDatePurchase").exists():
            ShowManDateAndExpDatePurchase = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, BranchID=BranchID, SettingsType="ShowManDateAndExpDatePurchase").SettingsValue
            if ShowManDateAndExpDatePurchase == "True":
                ShowManDateAndExpDatePurchase = True
            else:
                ShowManDateAndExpDatePurchase = False

        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID, SettingsType="ShowDiscountInPurchase").exists():
            ShowDiscountInPurchase = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, BranchID=BranchID, SettingsType="ShowDiscountInPurchase").SettingsValue
            if ShowDiscountInPurchase == "True":
                ShowDiscountInPurchase = True
            else:
                ShowDiscountInPurchase = False

        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID, SettingsType="SalesPriceUpdate").exists():
            SalesPriceUpdate = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, BranchID=BranchID, SettingsType="SalesPriceUpdate").SettingsValue
            if SalesPriceUpdate == "True":
                SalesPriceUpdate = True
            else:
                SalesPriceUpdate = False

        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID, SettingsType="PurchasePriceUpdate").exists():
            PurchasePriceUpdate = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, BranchID=BranchID, SettingsType="PurchasePriceUpdate").SettingsValue
            if PurchasePriceUpdate == "True":
                PurchasePriceUpdate = True
            else:
                PurchasePriceUpdate = False

        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID, SettingsType="AllowCashReceiptMoreSaleAmt").exists():
            AllowCashReceiptMoreSaleAmt = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, BranchID=BranchID, SettingsType="AllowCashReceiptMoreSaleAmt").SettingsValue
        ...
        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID, SettingsType="AllowAdvanceReceiptinSales").exists():
            AllowAdvanceReceiptinSales = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, BranchID=BranchID, SettingsType="AllowAdvanceReceiptinSales").SettingsValue
        ...
        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID, SettingsType="AllowQtyDividerinSales").exists():
            AllowQtyDividerinSales = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, BranchID=BranchID, SettingsType="AllowQtyDividerinSales").SettingsValue
        ...
        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID, SettingsType="ReferenceBillNo").exists():
            ReferenceBillNo = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, BranchID=BranchID, SettingsType="ReferenceBillNo").SettingsValue
        ...
        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID, SettingsType="BlockSalesPrice").exists():
            BlockSalesPrice = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, BranchID=BranchID, SettingsType="BlockSalesPrice").SettingsValue
            if BlockSalesPrice == "True":
                BlockSalesPrice = True
            else:
                BlockSalesPrice = False

        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID, SettingsType="ShowSettingsinSales").exists():
            ShowSettingsinSales = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, BranchID=BranchID, SettingsType="ShowSettingsinSales").SettingsValue
            if ShowSettingsinSales == "True":
                ShowSettingsinSales = True
            else:
                ShowSettingsinSales = False

        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID, SettingsType="EnableProductBatchWise").exists():
        ...
        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID, SettingsType="AllowUpdateBatchPriceInSales").exists():
        ...
        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID, SettingsType="EnableTransilationInProduct").exists():
            EnableTransilationInProduct = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, BranchID=BranchID, SettingsType="EnableTransilationInProduct").SettingsValue
            if EnableTransilationInProduct == "True":
                EnableTransilationInProduct = True
            else:
                EnableTransilationInProduct = False

        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID, SettingsType="ShowPositiveStockInSales").exists():
            ShowPositiveStockInSales = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, BranchID=BranchID, SettingsType="ShowPositiveStockInSales").SettingsValue
            if ShowPositiveStockInSales == "True":
                ShowPositiveStockInSales = True
            else:
                ShowPositiveStockInSales = False

        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID, SettingsType="ShowNegativeBatchInSales").exists():
            ShowNegativeBatchInSales = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, BranchID=BranchID, SettingsType="ShowNegativeBatchInSales").SettingsValue
            if ShowNegativeBatchInSales == "True":
                ShowNegativeBatchInSales = True
            else:
                ShowNegativeBatchInSales = False

        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID, SettingsType="CreateBatchForWorkOrder").exists():
            CreateBatchForWorkOrder = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, BranchID=BranchID, SettingsType="CreateBatchForWorkOrder").SettingsValue
            if CreateBatchForWorkOrder == "True":
                CreateBatchForWorkOrder = True
            else:
                CreateBatchForWorkOrder = False

        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID, SettingsType="ShowYearMonthCalanderInWorkOrder").exists():
            ShowYearMonthCalanderInWorkOrder = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, BranchID=BranchID, SettingsType="ShowYearMonthCalanderInWorkOrder").SettingsValue
            if ShowYearMonthCalanderInWorkOrder == "True":
                ShowYearMonthCalanderInWorkOrder = True
            else:
                ShowYearMonthCalanderInWorkOrder = False

        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID, SettingsType="KFC").exists():
            KFC = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, BranchID=BranchID, SettingsType="KFC").SettingsValue
            if KFC == "True":
                KFC = True
            else:
                KFC = False
        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID, SettingsType="BatchCriteria").exists():
            BatchCriteria = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, BranchID=BranchID, SettingsType="BatchCriteria").SettingsValue

        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID, SettingsType="blockSaleByBillDisct").exists():
            blockSaleByBillDisct = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, BranchID=BranchID, SettingsType="blockSaleByBillDisct").SettingsValue
...
def get_defaults(request):
    ...
    if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID).exists():
        ...
        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, SettingsType="ShowSettingsinSales").exists():
            ShowSettingsinSales = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, SettingsType="ShowSettingsinSales").SettingsValue
            if ShowSettingsinSales == "True":
                ShowSettingsinSales = True
            else:
                ShowSettingsinSales = False

        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, SettingsType="EnableProductBatchWise").exists():
            EnableProductBatchWise = administrations_models.GeneralSettings.objects.get(
        ...
        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, SettingsType="AllowUpdateBatchPriceInSales").exists():
            AllowUpdateBatchPriceInSales = administrations_models.GeneralSettings.objects.get(
        ...
        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, SettingsType="PurchasePriceUpdate").exists():
            PurchasePriceUpdate = administrations_models.GeneralSettings.objects.get(
        ...
        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, SettingsType="EnableTransilationInProduct").exists():
            EnableTransilationInProduct = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, SettingsType="EnableTransilationInProduct").SettingsValue
            if EnableTransilationInProduct == "True":
                EnableTransilationInProduct = True
            else:
                EnableTransilationInProduct = False

        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, SettingsType="ShowPositiveStockInSales").exists():
            ShowPositiveStockInSales = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, SettingsType="ShowPositiveStockInSales").SettingsValue
            if ShowPositiveStockInSales == "True":
                ShowPositiveStockInSales = True
            else:
                ShowPositiveStockInSales = False

        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, SettingsType="ShowNegativeBatchInSales").exists():
            ShowNegativeBatchInSales = administrations_models.GeneralSettings.objects.get(
        ...
        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, SettingsType="CreateBatchForWorkOrder").exists():
            CreateBatchForWorkOrder = administrations_models.GeneralSettings.objects.get(
        ...
        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, SettingsType="ShowYearMonthCalanderInWorkOrder").exists():
            ShowYearMonthCalanderInWorkOrder = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, SettingsType="ShowYearMonthCalanderInWorkOrder").SettingsValue
            if ShowYearMonthCalanderInWorkOrder == "True":
                ShowYearMonthCalanderInWorkOrder = True
            else:
                ShowYearMonthCalanderInWorkOrder = False

        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, SettingsType="KFC").exists():
            KFC = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, SettingsType="KFC").SettingsValue
            if KFC == "True":
                KFC = True
            else:
                KFC = False
        ...
        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, SettingsType="blockSaleByBillDisct").exists():
            blockSaleByBillDisct = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, SettingsType="blockSaleByBillDisct").SettingsValue
            if blockSaleByBillDisct == "True":
                blockSaleByBillDisct = True
            else:
                blockSaleByBillDisct = False
        ...
        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, SettingsType="AllowQtyDividerinSales").exists():
            AllowQtyDividerinSales = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, SettingsType="AllowQtyDividerinSales").SettingsValue
            if AllowQtyDividerinSales == "True":
                AllowQtyDividerinSales = True
            else:
                AllowQtyDividerinSales = False
        ...
        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, SettingsType="InclusiveRateWorkOrder").exists():
            InclusiveRateWorkOrder = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, SettingsType="InclusiveRateWorkOrder").SettingsValue
            if InclusiveRateWorkOrder == "True":
                InclusiveRateWorkOrder = True
            else:
                InclusiveRateWorkOrder = False
        ...
        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, SettingsType="ShowDiscountInSales").exists():
            ShowDiscountInSales = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, SettingsType="ShowDiscountInSales").SettingsValue
            if ShowDiscountInSales == "True":
                ShowDiscountInSales = True
            else:
                ShowDiscountInSales = False

        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, SettingsType="ShowManDateAndExpDatePurchase").exists():
            ShowManDateAndExpDatePurchase = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, SettingsType="ShowManDateAndExpDatePurchase").SettingsValue
            if ShowManDateAndExpDatePurchase == "True":
                ShowManDateAndExpDatePurchase = True
            else:
                ShowManDateAndExpDatePurchase = False

        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, SettingsType="ShowDiscountInPurchase").exists():
            ShowDiscountInPurchase = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, SettingsType="ShowDiscountInPurchase").SettingsValue
            if ShowDiscountInPurchase == "True":
                ShowDiscountInPurchase = True
            else:
                ShowDiscountInPurchase = False
