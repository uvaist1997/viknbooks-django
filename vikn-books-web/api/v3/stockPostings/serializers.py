...
class StockPostingRestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = StockPosting
        fields = ('id','StockPostingID','BranchID','Action','Date','VoucherMasterID','VoucherType','ProductID',
...
class ShortageStockMasterSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id','CompanyID','ShortageStockMasterID','BranchID','Action','VoucherNo','Date','Notes',
