...
from api.v3.productCategories.serializers import ProductCategoryRestSerializer
...
class ProductGroupRestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ProductGroup
        fields = ('id', 'ProductGroupID', 'BranchID', 'GroupName', 'CategoryID', 'ProductCategoryID',
