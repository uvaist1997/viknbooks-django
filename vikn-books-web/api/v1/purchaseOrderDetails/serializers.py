...
from brands.models import PurchaseOrderDetails, PurchaseOrderDetailsDummy, Product
...
class PurchaseOrderDetailsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id','BranchID','PurchaseOrderMasterID','DeliveryDetailsID','OrederDetailsID','ProductID',
...
class PurchaseOrderDetailsRestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PurchaseOrderDetails
        fields = ('id','PurchaseOrderDetailsID','BranchID','Action','PurchaseOrderMasterID','DeliveryDetailsID','OrederDetailsID','ProductID',
        	'Qty','FreeQty','UnitPrice',
...
class PurchaseOrderDetailsDummySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PurchaseOrderDetailsDummy
        fields = ('id','BranchID','BatchID','PurchaseOrderMasterID','DeliveryDetailsID','OrderDetailsID','ProductID','ProductName','Qty','FreeQty','UnitPrice','RateWithTax',
            'CostPerPrice','PriceListID','TaxID',
            'TaxType','DiscountPerc','DiscountAmount','GrossAmount','TaxableAmount','VATPerc','VATAmount',
            'SGSTPerc','SGSTAmount','CGSTPerc','CGSTAmount','IGSTPerc','IGSTAmount','NetAmount','detailID')
