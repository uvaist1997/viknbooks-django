...
from api.v1.transactionTypes import views
...
urlpatterns = [
    ...
    url(r'^view/transactionType/(?P<pk>.*)/$', views.transactionType, name='transactionType'),
    ...
    url(r'^transactionTypesByMasterName/$', views.transactionTypesByMasterName, name='transactionTypesByMasterName'),
]