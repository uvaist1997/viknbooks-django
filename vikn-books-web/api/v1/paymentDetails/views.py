...
from api.v1.paymentDetails.serializers import PaymentDetailsSerializer, PaymentDetailsRestSerializer, PaymentDetailsDummySerializer
from api.v1.brands.serializers import ListSerializer
from api.v1.paymentDetails.functions import generate_serializer_errors
from rest_framework import status
from api.v1.paymentDetails.functions import get_auto_id
import datetime
...
def list_paymentDetailsDummy(request):
    ...
    if serialized1.is_valid():
        ...
        if PaymentDetailsDummy.objects.filter(BranchID=BranchID).exists():
            ...
            serialized = PaymentDetailsDummySerializer(instances,many=True,context = {"DataBase": DataBase })
