...
from api.v1.purchaseOrderMaster.serializers import PurchaseOrderMasterSerializer, PurchaseOrderMasterRestSerializer
from api.v1.brands.serializers import ListSerializer
from api.v1.purchaseOrderMaster.functions import generate_serializer_errors
from rest_framework import status
from api.v1.purchaseOrderMaster.functions import get_auto_id
import datetime
...
def list_purchaseOrderMaster(request):
    ...
    if serialized1.is_valid():
        ...
        if PurchaseOrderMaster.objects.filter(BranchID=BranchID).exists():
            ...
            serialized = PurchaseOrderMasterRestSerializer(instances,many=True)
