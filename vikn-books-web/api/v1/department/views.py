...
from api.v1.department.serializers import DepartmentSerializer,DepartmentRestSerializer
...
def departments(request):
    ...
    if serialized1.is_valid():
        ...
        if Department.objects.filter(BranchID=BranchID,CompanyID=CompanyID).exists():
            ...
            serialized = DepartmentRestSerializer(instances,many=True,context = {"CompanyID": CompanyID })
            response_data = {
                "StatusCode" : 6000,
                "data" : serialized.data
            }
