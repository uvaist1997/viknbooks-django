...
UsedStockDetails,Warehouse, Unit, PriceList
...
class StockPostingRestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = StockPosting
        fields = ('id','StockPostingID','BranchID','Action','Date','VoucherMasterID','VoucherType','ProductID','UnitName','UserName',
            'BatchID','WareHouseID','WareHouseName','QtyIn','QtyOut','Rate','PriceListID','IsActive','CreatedDate','UpdatedDate','CreatedUserID')
...
class ExcessStockDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id','CompanyID','ExcessStockDetailsID','BranchID','Action','ExcessStockMasterID','ProductID','ProductName','Stock',
...
class ShortageStockDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id','CompanyID','ShortageStockDetailsID','BranchID','Action','ShortageStockMasterID','ProductID','ProductName','Stock',
...
class DamageStockDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id','CompanyID','DamageStockDetailsID','BranchID','Action','DamageStockMasterID','ProductID','ProductName','Stock',
...
class UsedStockDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id','CompanyID','UsedStockDetailsID','BranchID','Action','UsedStockMasterID','ProductID','ProductName','Stock',
            'PriceListID','UsedStock','CreatedDate','LastUPDDate','CreatedUserID','LastUPDUserID','CostPerItem','detailID')
