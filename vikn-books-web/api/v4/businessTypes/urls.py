...
from api.v4.businessTypes import views


urlpatterns = [
    url(r'^create-business-type/$', views.create_business_type,
    ...
    url(r'^edit-business-type/(?P<pk>.*)/$',
        views.edit_business_type, name='edit_business_type'),
