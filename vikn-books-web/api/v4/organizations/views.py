...
from api.v4.organizations.serializers import OrganizationSettingsSerializer, OrganizationUserListSerializer, OrganizationListSerializer, OrganizationSerializer
from api.v4.organizations.functions import generate_serializer_errors
...
def create_organization_settings(request):
    ...
    if serializer.is_valid():
        ...
        CompanySettings.objects.filter(owner__pk=Customer, pk=Organization).update(
            ExpiryDate=ExpiryDate, NoOfUsers=NoOfUsers)
