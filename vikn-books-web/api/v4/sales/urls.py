...
from api.v4.sales import views
...
urlpatterns = [
    ...
    url(r'^sales/gst-sale-report/$', views.gst_sales_report, name='gst_sales_report'),
    ...
    url(r'^sales-summary/report/$', views.sales_summary_report, name='sales_summary_report'),
    url(r'^supplierVsproduct/report/$', views.supplier_vs_product_report, name='supplier_vs_product_report'),
    ...
    url(r'^inventory-flow/report/$', views.inventory_flow_report, name='inventory_flow_report'),

    url(r'^sales/grand-totals/$', views.sales_grand_totals, name='sales_grand_totals'),
    url(r'^filterd-salesOreders/$', views.sales_filterd_sales_order, name='sales_filterd_sales_order'),
