...
from api.v4.workOrder import serializers
...
from api.v4.workOrder.functions import get_auto_id, get_auto_idMaster, get_auto_StockRateID, get_auto_StockTransID
