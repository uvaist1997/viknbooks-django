...
from api.v4.loyaltyCustomer import views
...
urlpatterns = [
    ...
    url(r'^get-cardNumber-detail/$', views.get_cardNumber_detail, name='get_cardNumber_detail'),
    url(r'^get-mobileNo-detail/$', views.get_mobileNo_detail, name='get_mobileNo_detail'),
]
