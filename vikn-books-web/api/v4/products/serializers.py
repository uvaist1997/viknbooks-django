...
from brands.models import Product, PriceList, Brand, ProductGroup, TaxCategory, Unit, StockPosting, Batch, GeneralSettings, Warehouse
from api.v4.priceLists.serializers import PriceListRestSerializer, SinglePriceListRestSerializer
from api.v4.workOrder.serializers import Batch_ListSerializer, UnitListSerializer
...
class ProductRestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ('id', 'ProductID', 'BranchID', 'ProductCode', 'ProductName', 'DisplayName', 'Description', 'ProductGroupID','is_Service',
