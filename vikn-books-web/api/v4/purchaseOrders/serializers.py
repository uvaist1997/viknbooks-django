...
class PurchaseOrderMasterRestSerializer(serializers.ModelSerializer):
    ...
    def get_PurchaseOrderDetails(self, instances):
        ...
        serialized = PurchaseOrderDetailsRestSerializer(purchaseOrder_details,many=True,context={"PriceRounding" : PriceRounding,"CompanyID" : CompanyID})
...
class PurchaseOrderDetailsRestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id','PurchaseOrderDetailsID','BranchID','Action','BatchID','PurchaseOrderMasterID',
            ...
            'CGSTPerc','CGSTAmount','IGSTPerc','IGSTAmount','NetAmount','TotalTax','TAX1Amount','TAX1Perc',
            ...
            'unitPriceRounded','quantityRounded','actualSalesPrice','actualPurchasePrice','netAmountRounded','BatchCode','UnitList','Flavour')
