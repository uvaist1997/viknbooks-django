...
from brands.models import SalesEstimateMaster, SalesEstimateDetails, AccountLedger, Product, PriceList, Unit, TaxCategory
...
class SalesEstimateMasterRestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SalesEstimateMaster
        fields = ('id', 'SalesEstimateMasterID', 'BranchID', 'Action', 'VoucherNo', 'Date', 'LedgerID', 'LedgerName',
