...
class ReceiptMasterRestSerializer(serializers.ModelSerializer):
    ...
    def get_ReceiptDetails(self, instances):
        ...
        receipt_details = ReceiptDetails.objects.filter(CompanyID=CompanyID,ReceiptMasterID=instances.ReceiptMasterID,BranchID=instances.BranchID,VoucherType=VoucherType)
