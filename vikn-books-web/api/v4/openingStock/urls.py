...
from api.v4.openingStock import views
...
urlpatterns = [
    ...
    url(r'^openingStocks-filter/$', views.openingStocks_filter, name='openingStocks_filter'),
    url(r'^openingStock-report/$', views.openingStocks_report, name='openingStocks_report'),
    url(r'^openingStocks-xls-read/$', views.openingStocks_xls_read, name='openingStocks_xls_read'),
]
