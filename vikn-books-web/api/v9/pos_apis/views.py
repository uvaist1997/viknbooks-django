...
from api.v9.pos_apis.serializers import Faera_Serializer, POS_ProductListFilter_Serializer, POS_ProductList_Serializer, POS_Sales_Serializer, POS_BranchList_Serializer, POSEmployeeSerializer
from api.v9.brands.serializers import ListSerializer
from api.v9.pos_apis.functions import device_code_exist, generate_serializer_errors, get_pin_no, get_TokenNo, get_KitchenID
from rest_framework import status
import datetime
from main.functions import converted_float, generate_random_nos, get_GeneralSettings, get_company, activity_log, get_price_category, get_route, get_warehouse, remove_from_string
...
from api.v9.users.serializers import LoginSerializer, MyCompaniesSerializer, CompaniesSerializer
...
from api.v9.sales.functions import set_LoyaltyCalculation, get_Genrate_VoucherNo, get_auto_id, get_auto_idMaster, get_auto_stockPostid
from api.v9.accountLedgers.functions import get_auto_LedgerPostid, get_LedgerCode, get_auto_id as generated_ledgerID, UpdateLedgerBalance
from api.v9.salesReturns.functions import get_auto_idMaster as get_returnMasterID, get_auto_id as get_returnDetailID
from api.v9.branchs.functions import get_branch_settings
from api.v9.products.utils import in_memory_file_to_temp
        ...
        if table.POS_Devices.objects.filter(id=unq_id).exists():
            ...
            if user_datas:
                ...
                for u in user_datas:
                    ...
                    if table.UserTable.objects.filter(id=u["UserID"]).exists():
                        userTable = table.UserTable.objects.get(id=u["UserID"])
