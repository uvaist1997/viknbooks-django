...
from api.v9.priceLists.serializers import PriceListRestSerializer, PriceListSerializer
from api.v9.products.functions import (
...
from api.v9.products.serializers import (
...
from api.v9.products.tasks import import_multyUnit_task, import_product_task
    ...
    if product_serialized.is_valid():
        ...
        if contains_duplicates == False:
            if ProductBarcode.objects.filter(
                ...
                list_barcodes = ProductBarcode.objects.filter(
                    CompanyID=CompanyID, BranchID=BranchID, Barcode__in=barcode_arr
                )
