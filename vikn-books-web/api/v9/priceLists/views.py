...
from api.v9.priceLists.serializers import PriceListSerializer, PriceListRestSerializer, ListSerializer
from api.v9.priceLists.functions import generate_serializer_errors
from rest_framework import status
from api.v9.priceLists.functions import get_auto_id
from api.v9.products.functions import get_auto_AutoBarcode
import datetime
...
def single_priceList(request):
    ...
    if price_list_instance.exists():
        ...
        serialized = PriceListRestSerializer(
            instance, context={"CompanyID": CompanyID,"LedgerID": LedgerID, "PriceRounding": PriceRounding})
