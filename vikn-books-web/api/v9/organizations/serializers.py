...
class OrganizationSettingsSerializer(serializers.Serializer):
    ...
    EditionName = serializers.CharField()
    IsTrialVersion = serializers.BooleanField()
...
class OrganizationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id','Action','Customerid','CompanyName','State','Permission','IsTrialVersion','Edition','Country','Phone','Mobile','Email','Website','ExpiryDate','NoOfUsers','username','status','is_deleted','CreatedDate','RegisteredDate','Edition')
