...
from api.v9.transactionTypes.serializers import TransactionTypesSerializer, TransactionTypesRestSerializer, ListSerializerByMasterName
from rest_framework.renderers import JSONRenderer
from rest_framework.decorators import api_view, permission_classes, renderer_classes
from rest_framework.response import Response
from rest_framework.permissions import AllowAny, IsAuthenticated
from api.v9.loyaltyCustomer.serializers import LoyaltyCustomerSerializer, LoyaltyCustomerRestSerializer
from api.v9.brands.serializers import ListSerializer
from api.v9.loyaltyCustomer.functions import generate_serializer_errors
from rest_framework import status
from api.v9.loyaltyCustomer.functions import get_auto_id, get_auto_DepartmentID
from main.functions import get_company, activity_log
import datetime
from api.v9.accountLedgers.serializers import AccountLedgerSerializer, AccountLedgerRestSerializer, LedgerReportSerializer, AccountLedgerListSerializer
        ...
        if not MobileNo_ok:
            if not CardNumber_ok:
                ...
                if not loyalty_instances.filter(AccountLedgerID=sundry_debtor_instance,MobileNo=MobileNo,CardNumber=CardNumber):
                    ...
                    print(card_status_instance,"card_status_instance")
                    print(card_type_instance,"card_type_instance")
