...
from api.v9.sales.serializers import GST_finalList_fun, QRCodeSerializer, SalesDetailsRestSerializer, SerialNumberSerializer, ShippingAddressListSerializer, get_treatment_name
...
class ExpenseListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'VoucherNo', 'TotalAmount', 'TaxPerc','TaxAmount', 'NetTotal',
                  ...
                  'TotalCGSTAmount', 'TaxNo', 'TaxID', 'TaxName', 'MasterUid')
...
class StockOrderListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'VoucherNo', 'GrandTotal',
                  'Date', 'WarehouseFrom', 'WarehouseTo', 'StockTransferMasterID')
