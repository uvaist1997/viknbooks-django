...
from brands.models import LoyaltyPoint,SalesEstimateMaster, SalesEstimateDetails, SalesMaster, SalesDetails, Product, AccountLedger, Warehouse, PriceList, SerialNumbers, TransactionTypes, Unit,\
...
class SalesMasterRestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'TotalTax_rounded','GrandTotal_Rounded','ShippingCharge','shipping_tax_amount','TaxTypeID','SAC','SalesTax','LoyaltyCustomerID','LoyaltyCustomerName','TotalTaxableAmount', 'SalesMasterID', 'BranchID', 'Action', 'VoucherNo', 'Date',
...
class SalesMasterRest1Serializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'SalesMasterID', 'VoucherNo', 'Date','TotalTax_rounded','GrandTotal_Rounded',
                   'LedgerName', 'CustomerName', 'TotalTax',
                  'GrandTotal')
...
class StockSerializer(serializers.ModelSerializer):
    ...
    def get_Cost(self, instance):
        ...
        if StockPosting.objects.filter(ProductID=ProductID, CompanyID=CompanyID, WareHouseID=WareHouseID, QtyIn__gt=0, Date__lte=ToDate, VoucherType="PI").exists():
            stock_ins = StockPosting.objects.filter(
                ProductID=ProductID, CompanyID=CompanyID, WareHouseID=WareHouseID, QtyIn__gt=0, Date__lte=ToDate, VoucherType="PI")
            TotalQtyInRate = 0
            TotalQtyIn = 0
...
class BillWiseSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SalesMaster
        fields = ('id', 'Date', 'VoucherNo','TotalGrossAmt','VATAmount','NetAmount','NetCost','Profit','GrandTotal')
