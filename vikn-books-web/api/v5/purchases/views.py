from brands.models import PurchaseMaster, AccountLedger_Log,PurchaseMaster_Log, PurchaseDetails, PurchaseDetails_Log, StockPosting, LedgerPosting, StockPosting_Log,\
...
from api.v5.purchases.serializers import PurchaseMasterSerializer, PurchaseMasterRestSerializer, PurchaseMasterRest1Serializer, PurchaseDetailsSerializer,\
...
from api.v5.purchases.functions import get_auto_id, get_auto_idMaster, get_auto_StockRateID, get_auto_StockTransID
...
from api.v5.purchaseOrders.serializers import PurchaseOrderMasterRestSerializer
    ...
    if serialized1.is_valid():
        ...
        if PurchaseMaster.objects.filter(CompanyID=CompanyID, BranchID=BranchID).exists():
            ...
            if page_number and items_per_page:
                ...
                serialized = PurchaseMasterRestSerializer(purchase_sort_pagination, many=True, context={"CompanyID": CompanyID,
