...
class WorkOrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'WorkOrderMasterID','BatchPurchasePrice', 'BranchID','UnitList', 'Action', 'VoucherNo', 'Date', 'WareHouseID', 'WareHouseName', 'Notes', 'ProductID', 'ProductName', 'ManufactureDate', 'ExpiryDate',
                  'ProductQty', 'CostPerPrice', 'UnitPrice', 'PriceListID', 'Barcode', 'AutoBarcode', 'UnitName', 'Amount', 'Weight', 'TotalQty', 'GrandTotal','GrandTotal_Rounded', 'IsActive', 'CreatedDate', 'UpdatedDate', 'CreatedUserID', 'BatchCode',
