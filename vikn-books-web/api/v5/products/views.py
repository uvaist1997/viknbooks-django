from brands.models import Product,ProductBarcode, Product_Log, PriceList, PriceList_Log, PurchaseDetails, PurchaseOrderDetails, SalesDetails, SalesOrderDetails, StockPosting, TaxCategory, TaxCategory_Log, Brand, Brand_Log, ProductGroup, ProductGroup_Log, Unit, Unit_Log, Batch, GeneralSettings
from rest_framework.renderers import JSONRenderer
from rest_framework.decorators import api_view, permission_classes, renderer_classes
from rest_framework.response import Response
from rest_framework.permissions import AllowAny, IsAuthenticated
from api.v5.products.serializers import ProductSerializer, SingleProductRestSerializer, ProductRestSerializer, ProductbyGrouptSerializer, BarCodeSearchSerializer, UploadSerializer, ProductSearchShortcutSerializer, ListSerializerforReport, StockSerializer
from api.v5.priceLists.serializers import PriceListSerializer, PriceListRestSerializer
from api.v5.brands.serializers import ListSerializer
from api.v5.products.functions import generate_serializer_errors, generate_priceList_serializer_errors,get_auto_ProductBarcode
from rest_framework import status
from api.v5.products.functions import get_auto_id, get_auto_priceListid, get_ProductCode, get_auto_AutoBarcode, get_auto_BatchNo, get_auto_AutoBatchCode
import datetime
...
from api.v5.products.tasks import import_product_task
from celery.result import AsyncResult
from api.v5.products.utils import in_memory_file_to_temp
from django.db.models import Max, Q, Prefetch, Sum
import time
from api.v6.products.serializers import ProductSearchInvoiceSerializer
        ...
        if not contains_duplicates:
            ...
            if product_ok and productCode_ok:
                ...
                for PD in price_ToDelete:
                    PD.delete()
                for PD in product_barcode_ToDelete:
                    PD.delete()
