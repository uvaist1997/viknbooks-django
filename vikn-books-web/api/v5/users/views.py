from brands.models import TransactionTypes_Log,UserTable, User_Log, UserType, CompanySettings, SoftwareVersion, SoftwareVersionLog, MasterType, MasterType_Log
...
from django.contrib.auth.models import User, Group
from api.v5.users.functions import get_auto_id

from api.v5.transactionTypes.functions import get_auto_id as tran_get_auto_id 

from brands import models
from api.v5.general.functions import get_current_role
...
from api.v5.users.functions import send_email, get_master_auto_id
...
from api.v5.users.serializers import CustomTokenSerializer, SoftwareVersionSerializer
...
def get_defaults(request):
    ...
    # =============Uvais================
    if not TransactionTypes.objects.filter(CompanyID__pk=CompanyID, BranchID=BranchID, Name="Re Submitted").exists():
        ...
        TransactionTypesID = tran_get_auto_id(TransactionTypes, BranchID, CompanyID)
