...
class AccountLedgerRestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = AccountLedger
        fields = ('id', 'LedgerID', 'BranchID', 'LedgerName', 'LedgerCode', 'AccountGroupUnder', 'AccountGroupName', 'OpeningBalance',
...
class AccountLedgerListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = AccountLedger
        fields = ('id', 'LedgerID', 'BranchID', 'LedgerName', 'LedgerCode', 'AccountGroupUnder', 'CustomerLedgerBalance', 'AccountGroupName', 'DisplayName', 'Address', 'City','Attention',
                  'State', 'Country', 'PostalCode', 'OpeningBalance', 'CustomerBalance', 'CrOrDr', 'Notes', 'IsActive', 'IsDefault', 'CreatedDate', 'UpdatedDate', 'CreatedUserID', 'Action')
