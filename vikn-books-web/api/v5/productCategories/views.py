...
from api.v5.productCategories.serializers import ProductCategorySerializer, ProductCategoryRestSerializer
from api.v5.brands.serializers import ListSerializer
from api.v5.productCategories.functions import generate_serializer_errors
from rest_framework import status
from api.v5.productCategories.functions import get_auto_id
import datetime
    ...
    if serialized1.is_valid():
        ...
        if ProductCategory.objects.filter(CompanyID=CompanyID, BranchID=BranchID).exists():
            if page_number and items_per_page:
                ...
                ledger_sort_pagination = ProductCategory.objects.filter(
                    CompanyID=CompanyID, BranchID=BranchID)
