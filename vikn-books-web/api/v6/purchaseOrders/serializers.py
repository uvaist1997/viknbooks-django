...
class PurchaseOrderMasterRestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'PurchaseOrderMasterID','ShippingCharge','shipping_tax_amount','TaxTypeID','SAC','PurchaseTax', 'BranchID', 'Action', 'VoucherNo', 'Date', 'DetailID',
                  ...
                  'PriceCategoryID', 'CustomerName', 'Address1', 'DeliveryDate', 'IsInvoiced','Country_of_Supply','State_of_Supply','GST_Treatment',
    ...
    def get_PurchaseOrderDetails(self, instances):
        ...
        purchaseOrder_details = PurchaseOrderDetails.objects.filter(CompanyID=CompanyID,PurchaseOrderMasterID=instances.PurchaseOrderMasterID, BranchID=instances.BranchID).order_by('PurchaseOrderDetailsID')
...
class PurchaseOrderDetailsRestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PurchaseOrderDetails
        fields = ('id', 'PurchaseOrderDetailsID', 'BranchID', 'Action', 'BatchID', 'PurchaseOrderMasterID','ProductTaxID',
                  'ProductID', 'Qty', 'FreeQty', 'InclusivePrice', 'ProductName', 'ReturnQty', 'AddlDiscPerc', 'AddlDiscAmt',
                  'UnitPrice', 'RateWithTax', 'CostPerItem', 'PriceListID', 'DiscountPerc', 'UnitName', 'unq_id', 'detailID','is_inclusive',
                  ...
                  'ProductTaxName','GST_Inclusive','Vat_Inclusive','PurchasePrice')
