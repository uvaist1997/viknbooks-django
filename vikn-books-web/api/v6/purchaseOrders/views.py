from brands.models import VoucherNoTable,PurchaseOrderMaster, PurchaseOrderMaster_Log, PurchaseOrderDetails, PurchaseOrderDetails_Log, PurchaseOrderDetailsDummy, GeneralSettings
from rest_framework.renderers import JSONRenderer
from rest_framework.decorators import api_view, permission_classes, renderer_classes
from rest_framework.response import Response
from rest_framework.permissions import AllowAny, IsAuthenticated
from api.v6.purchaseOrders.serializers import PurchaseOrderMasterSerializer, PurchaseOrderMasterRestSerializer, PurchaseOrderDetailsSerializer, PurchaseOrderDetailsRestSerializer, PurchaseOrderReportSerializer,PurchaseOrderMaster1RestSerializer
from api.v6.brands.serializers import ListSerializer
from api.v6.purchaseOrders.functions import generate_serializer_errors
from rest_framework import status
from api.v6.purchaseOrders.functions import get_auto_id, get_auto_idMaster
import datetime
...
def create_purchaseOrder(request):
    try:
        with transaction.atomic():
            ...
            insts = PurchaseOrderMaster.objects.filter(CompanyID=CompanyID,BranchID=BranchID)
            if insts:
                for i in insts:
        ...
        activity_log(request._request, CompanyID, 'Error', CreatedUserID, 'Purchase Order',
