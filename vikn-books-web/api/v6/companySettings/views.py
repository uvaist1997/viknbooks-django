from brands.models import CancelReasons,Edition,CompanySettings, CompanySettings_Log, Designation, Department, AccountLedger, TransactionTypes, Warehouse, UserType, AccountGroup, Bank, Branch, Brand, Flavours, Color, GeneralSettings, MasterType, PriceCategory, ProductCategory, ProductGroup, Route, TaxCategory, TaxType, Country, Unit, FinancialYear, FinancialYear_Log, Unit, State, BusinessType, UserTable, Customer, User_Log
from rest_framework.renderers import JSONRenderer
from rest_framework.decorators import api_view, permission_classes, renderer_classes
from rest_framework.response import Response
from rest_framework.permissions import AllowAny, IsAuthenticated
from api.v6.companySettings.serializers import CompanySettingsRestSerializer, CompanySettingsInitialSerializer, FinancialYearSerializer
from api.v6.companySettings.functions import generate_serializer_errors
from rest_framework import status
from api.v6.companySettings.serializers import CompanySettingsSerializer,EditionSerializer
...
from api.v6.general.functions import isValidMasterCardNo
from api.v6.settings.functions import create_or_update_user_type_settings
...
def create_companySettings_initial(request):
    ...
    if serialized.is_valid() and serialized1.is_valid():
        ...
        if is_Gstn_validate:
            ...
            THIS_FOLDER = os.path.dirname(os.path.abspath(__file__))
            path = os.path.join(THIS_FOLDER, 'company_fixtures/cancel_reasons.json')
