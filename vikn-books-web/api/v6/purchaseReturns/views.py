...
from api.v6.purchaseReturns.serializers import PurchaseReturnMasterSerializer,PurchaseReturn1MasterRestSerializer, PurchaseReturnMasterRestSerializer, PurchaseReturnDetailsSerializer, PurchaseReturnDetailsRestSerializer
from api.v6.brands.serializers import ListSerializer
from api.v6.purchaseReturns.functions import generate_serializer_errors
from rest_framework import status
from api.v6.sales.serializers import ListSerializerforReport
from api.v6.purchaseReturns.functions import get_auto_id, get_auto_idMaster
    ...
    try:
        with transaction.atomic():
            ...
            if is_PurchaseReturnOK:
                ...
                url = str("http://localhost:3000/invoice/") + str(purchase_instance.pk)+str('/')+ str('PR')
                print(url)
