...
from api.v6.sales.serializers import SerialNumberSerializer
...
class SalesReturnMasterRestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SalesReturnMaster
        fields = ('id','Date','Tax_no','CRNo','Mobile','City','State','Country','PostalCode','NetTotal_print','TotalGrossAmt_print','TotalTax_print', 'TotalDiscount_print','GrandTotal_print','qr_image', 'LoyaltyCustomerID', 'TotalTaxableAmount', 'SalesReturnMasterID', 'BranchID', 'Action', 'VoucherNo', 'VoucherDate', 'RefferenceBillNo',
...
class SalesReturnDetailsRestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SalesReturnDetails
        fields = ('id', 'unq_id','NetAmount_print','unitPrice_print', 'SalesReturnDetailsID', 'Description', 'BranchID', 'Action', 'SalesReturnMasterID', 'DeliveryDetailsID', 'OrderDetailsID', 'ProductID',
