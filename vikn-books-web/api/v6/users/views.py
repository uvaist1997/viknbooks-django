...
def general_settings_list(request):
    ...
    if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, BranchID=BranchID).exists():
        ...
        if administrations_models.GeneralSettings.objects.filter(CompanyID=CompanyID, SettingsType="CustomerBasedPrint").exists():
            CustomerBasedPrint = administrations_models.GeneralSettings.objects.get(
                CompanyID=CompanyID, SettingsType="CustomerBasedPrint").SettingsValue
...
def get_defaults(request):
    ...
    if GeneralSettings.objects.filter(CompanyID=CompanyID,SettingsType="VAT").exists():
        vat = GeneralSettings.objects.get(CompanyID=CompanyID,SettingsType="VAT").SettingsValue
    if GeneralSettings.objects.filter(CompanyID=CompanyID,SettingsType="GST").exists():
        gst = GeneralSettings.objects.get(CompanyID=CompanyID,SettingsType="GST").SettingsValue
