...
from api.v6.priceLists.serializers import PriceListRestSerializer, SinglePriceListRestSerializer
from api.v6.workOrder.serializers import Batch_ListSerializer, UnitListSerializer
...
class ProductSearchSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ('id', 'ProductID','ProductCode','ProductName','Stock','HSNCode','PurchasePrice','SalesPrice','is_inclusive')
