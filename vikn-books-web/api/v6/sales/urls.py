...
from api.v6.sales import views
...
urlpatterns = [
    ...
    url(r'^runAPIfor-gstr1-report/$',views.runAPIfor_gstr1_report, name='runAPIfor_gstr1_report'),
    url(r'^scanned-invoice/$', views.scanned_invoice, name='scanned_invoice'),


    url(r'^sales/gstR-report-excel/$',views.gstR_report_excel, name='gstR_report_excel'),
    url(r'^sales/gstR-report1/$',views.gstR_report1, name='gst_report1'),

    url(r'^sales-gst-report-excel/$',views.sales_gst_report_excel, name='sales_gst_report_excel'),
