...
from api.v6.workOrder.serializers import Batch_ListSerializer
...
class SalesDetailsRestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SalesDetails
        fields = ('id', 'unq_id', 'SalesDetailsID', 'BranchID', 'Action', 'SalesMasterID', 'ProductID', 'ProductName','ProductTaxID',
