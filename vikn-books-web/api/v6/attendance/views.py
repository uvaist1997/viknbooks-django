from brands.models import AttendanceMaster, AttendanceMaster_Log, Category, Employee, AttendanceDetail, AttendanceDetail_Log
from rest_framework.renderers import JSONRenderer
from rest_framework.decorators import api_view, permission_classes, renderer_classes
from rest_framework.response import Response
from rest_framework.permissions import AllowAny, IsAuthenticated
from api.v6.attendance.serializers import AttendanceMasterSerializer, AttendanceSingleSerializer, AttendanceMasterRestSerializer, AttendanceDetailSerializer
from api.v6.brands.serializers import ListSerializer
from api.v6.attendance.functions import generate_serializer_errors
from rest_framework import status
from api.v6.attendance.functions import get_auto_id, get_auto_DepartmentID
        ...
        if attendance_ok:
            ...
            for i in AttendanceDetails_list:
                ...
                if detailID == 0:
                    ...
                    attendanceDetail_instance = AttendanceDetail.objects.get(
                        pk=pk)
                    attendanceDetail_instance.EmployeeID = employee_instance
                    attendanceDetail_instance.EmployeeCode = employee_instance.EmployeeCode
...
def attendances(request):
    ...
    if serialized1.is_valid():
        ...
        if AttendanceMaster.objects.filter(BranchID=BranchID, CompanyID=CompanyID).exists():
