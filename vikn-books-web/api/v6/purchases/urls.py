...
from api.v6.purchases import views
...
urlpatterns = [
    ...
    url(r'^purchase-taxgroup-report-excel/$',views.purchase_taxgroup_report_excel, name='purchase_taxgroup_report_excel'),
    url(r'^purchase-gst-report-excel/$',views.purchase_gst_report_excel, name='purchase_gst_report_excel'),
]
