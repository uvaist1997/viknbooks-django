...
class PurchaseMasterRestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PurchaseMaster
        fields = ('id','TotalDiscount_print', 'TotalGrossAmt_print', 'PurchaseMasterID','ShippingCharge','shipping_tax_amount','TaxTypeID','SAC','PurchaseTax','CashName','BankName',"CashID","BankID", 'BranchID','TotalTaxableAmount', 'Action', 'VoucherNo', 'RefferenceBillNo', 'Date',
                  'VenderInvoiceDate', 'CreditPeriod', 'LedgerID', 'LedgerName','TotalTax_rounded','GrandTotal_Rounded','Country_of_Supply','State_of_Supply','GST_Treatment','VAT_Treatment',
