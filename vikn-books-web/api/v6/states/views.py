from brands.models import State, Product, Country, CompanySettings,UQCTable
from rest_framework.renderers import JSONRenderer
from rest_framework.decorators import api_view, permission_classes, renderer_classes
from rest_framework.response import Response
from rest_framework.permissions import AllowAny, IsAuthenticated
from api.v6.states.serializers import StateSerializer, StateRestSerializer, ListSerializer,UQCSerializer
from api.v6.states.functions import generate_serializer_errors
from rest_framework import status
from api.v6.states.functions import get_auto_id
