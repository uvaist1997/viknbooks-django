...
from api.v6.payments.serializers import PaymentMasterSerializer, PaymentMasterRestSerializer, PaymentDetailsSerializer, PaymentDetailsRestSerializer
from api.v6.payments.serializers import ListSerializer
from api.v6.payments.functions import generate_serializer_errors
from rest_framework import status
from api.v6.payments.functions import get_auto_id, get_auto_idMaster, get_auto_VoucherNo
...
from api.v6.receipts.functions import get_voucher_type
    ...
    if PaymentMaster.objects.filter(CompanyID=CompanyID, pk=pk).exists():
        ...
        if LedgerPosting.objects.filter(CompanyID=CompanyID, VoucherMasterID=PaymentMasterID, BranchID=BranchID, VoucherType=VoucherType).exists():
            ...
            for ledgerPostInstance in ledgerPostInstances:
                ...
                PaymentDetailsID = ledgerPostInstance.PaymentDetailsID
