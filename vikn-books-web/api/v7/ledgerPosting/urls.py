...
from api.v7.ledgerPosting import views
...
urlpatterns = [
    ...
    url(r'^ledgerReport-excel/$', views.ledgerReport_excel, name='ledgerReport_excel'),
    url(r'^trialBalance-excel/$', views.trialBalance_excel, name='trialBalance_excel'),
    url(r'^profit-and-loss-excel/$', views.profitAndLoss_excel, name='profitAndLoss_excel'),
    url(r'^balance-Sheet-excel/$', views.balanceSheet_excel, name='balanceSheet_excel'),
