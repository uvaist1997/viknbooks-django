...
def profitAndLoss_excel_data(key,CompanyID,CreatedUserID,PriceRounding,BranchID,ToDate,FromDate,request,ManualOpeningStock,ManualClosingStock):
    ...
    if LedgerPosting.objects.filter(CompanyID=CompanyID, BranchID=BranchID).exists():
        ...
        profitAndLoss_final_data = profitAndLoss_balancing(key,DirExPCons,DirIncCons,inDirExpCons,inDirIncCons,is_DirectincomeGreater,is_DirectexpenseGreater,is_IndirectexpenseGreater,is_IndirectincomeGreater
        ,Indirectdifference,Direct_difference,TotalDirect,TotalIndirect,Direct_Expenses_Array,Indirect_Expenses_Array,Direct_Income_Array,Indirect_Income_Array,TotalAvgValueOpening,TotalAvgValueClosing
        )
...
def profitAndLoss_balancing(key,DirExPCons,DirIncCons,inDirExpCons,inDirIncCons,DirectIncomeGreater,DirectExpenseGreater,IndirectExpenseGreater,IndirectIncomeGreater,Indirectdifference,Direct_difference,TotalDirect,TotalIndirect,DirectExpensesData,InDirectExpensesData,DirectIncomeData,IndirectIncomeData,OpeningStock,ClosingStock):
    ...
    if key == 1:
        ...
        for i in range(loop_count):
            ...
            dic = {"expence":{'name':exp_name,'balance':exp_balance},"income":{"name":inc_name,"balance":inc_balance}}
            profitAndLoss_final_data.append(dic)
        # Gross Profit
        if DirectIncomeGreater:
            dic = {"expence":{'name':'Gross Profit','balance':Direct_difference},"income":{"name":"-","balance":"-"}}
            profitAndLoss_final_data.append(dic)
        # Gross Loss
        elif DirectExpenseGreater:
            dic = {"expence":{'name':"-",'balance':"-"},"income":{"name":"Gross Loss","balance":Direct_difference}}
            profitAndLoss_final_data.append(dic)
        
        # Total Direct
        dic = {"expence":{'name':'Total','balance':TotalDirect},"income":{"name":"Total","balance":TotalDirect}}
        profitAndLoss_final_data.append(dic)
        # ==========================
        ...
        # Net Profit
        if IndirectIncomeGreater:
            dic = {"expence":{'name':'Net Profit','balance':Indirectdifference},"income":{"name":"-","balance":"-"}}
            profitAndLoss_final_data.append(dic)
        # Net Loss
        elif IndirectExpenseGreater:
            dic = {"expence":{'name':"-",'balance':"-"},"income":{"name":"Net Loss","balance":Indirectdifference}}
            profitAndLoss_final_data.append(dic)
        
        # Total Direct
        dic = {"expence":{'name':'Total','balance':TotalIndirect},"income":{"name":"Total","balance":TotalIndirect}}
        profitAndLoss_final_data.append(dic)
    ...
    if key == 2:
        ...
        # Direct Start heare=======================
        # OpeningStock
        dic = {"expence":{'group_name':"OpeningStock",'ledger_name':"-",'balance':OpeningStock},"income":{"group_name":"-",'ledger_name':"-","balance":"-"}}
        profitAndLoss_final_data.append(dic)
        ...
        for (exp, inc) in itertools.zip_longest(DirectExpensesData[0], DirectIncomeData[0], fillvalue=""):
            ...
            dic = {"expence":{'group_name':exp_grp_name,'ledger_name':"-",'balance':"-"},"income":{'group_name':inc_grp_name,'ledger_name':"-",'balance':"-"}}
            profitAndLoss_final_data.append(dic)
            for (exp_detail, inc_detail) in itertools.zip_longest(DirectExpensesData[0][exp], DirectIncomeData[0][inc], fillvalue=""):
                ...
                dic = {"expence":{'group_name':"",'ledger_name':exp_name,'balance':exp_balance},"income":{'group_name':"-",'ledger_name':inc_name,'balance':inc_balance}}
                profitAndLoss_final_data.append(dic)
        # ClosingStock
        dic = {"expence":{'group_name':"-",'ledger_name':"-",'balance':"-"},"income":{"group_name":"ClosingStock",'ledger_name':"-","balance":ClosingStock}}
        profitAndLoss_final_data.append(dic)  
        # Gross Profit
        if DirectIncomeGreater: 
            dic = {"expence":{'group_name':"Gross Profit",'ledger_name':"-",'balance':Direct_difference},"income":{"group_name":"-",'ledger_name':"-","balance":"-"}}
            profitAndLoss_final_data.append(dic)  
        # Gross Loss
        if DirectExpenseGreater: 
            dic = {"expence":{'group_name':"-",'ledger_name':"-",'balance':"-"},"income":{"group_name":"Gross Loss",'ledger_name':"-","balance":Direct_difference}}
            profitAndLoss_final_data.append(dic)  
        # Total
        dic = {"expence":{'group_name':"Total",'ledger_name':"-",'balance':TotalDirect},"income":{"group_name":"Total",'ledger_name':"-","balance":TotalDirect}}
        profitAndLoss_final_data.append(dic)
        # ^^^^^^^^^^^^^^^
        ...
        # Gross Profit
        if DirectExpenseGreater: 
            dic = {"expence":{'group_name':"Gross Loss",'ledger_name':"-",'balance':Direct_difference},"income":{"group_name":"-",'ledger_name':"-","balance":"-"}}
            profitAndLoss_final_data.append(dic)  
        # Gross Loss
        if DirectIncomeGreater: 
            dic = {"expence":{'group_name':"-",'ledger_name':"-",'balance':"-"},"income":{"group_name":"Gross Profit",'ledger_name':"-","balance":Direct_difference}}
            profitAndLoss_final_data.append(dic)  
        ...
        for (exp, inc) in itertools.zip_longest(InDirectExpensesData[0], IndirectIncomeData[0], fillvalue=""):
            ...
            for (exp_detail, inc_detail) in itertools.zip_longest(InDirectExpensesData[0][exp], IndirectIncomeData[0][inc], fillvalue=""):
                ...
                try:
                    ...
                    inc_balance = "-"
                print (exp_name,"DETAIL", inc_name)
                dic = {"expence":{'group_name':"",'ledger_name':exp_name,'balance':exp_balance},"income":{'group_name':"-",'ledger_name':inc_name,'balance':inc_balance}}
                profitAndLoss_final_data.append(dic)
        # Net Profit
        if IndirectIncomeGreater:
            dic = {"expence":{'group_name':"Net Profit",'ledger_name':"-",'balance':Indirectdifference},"income":{'group_name':"-",'ledger_name':"",'balance':""}}
            profitAndLoss_final_data.append(dic)
        # Net Loss
        elif IndirectExpenseGreater:
            dic = {"expence":{'group_name':"-",'ledger_name':"-",'balance':'-'},"income":{'group_name':"Net Loss",'ledger_name':"",'balance':Indirectdifference}}
            profitAndLoss_final_data.append(dic)
        
        # Total InDirect
        dic = {"expence":{'group_name':"Total",'ledger_name':"-",'balance':TotalIndirect},"income":{'group_name':"Total",'ledger_name':"",'balance':TotalIndirect}}
        profitAndLoss_final_data.append(dic)
