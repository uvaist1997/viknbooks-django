...
from api.v7.expense import serializers as serializer
from rest_framework.renderers import JSONRenderer
from rest_framework.decorators import api_view, permission_classes, renderer_classes,authentication_classes
from rest_framework.response import Response
from rest_framework_simplejwt.authentication import JWTTokenUserAuthentication
from api.v7.brands.serializers import ListSerializer
from api.v7.purchases.functions import generate_serializer_errors
from rest_framework import status
from api.v7.accountLedgers.functions import get_auto_LedgerPostid
import datetime
...
from api.v7.accountLedgers.functions import get_LedgerCode, get_auto_id as generated_ledgerID,UpdateLedgerBalance
import math
...
from api.v7.expense.functions import get_masterID,get_detailID
            ...
            if is_ExpenseOK:
                ...
                if TaxType == 'VAT':
                    if float(TotalVATAmount) > 0:
                        ...
                        update_ledger = UpdateLedgerBalance(CompanyID,BranchID,53,ExpenseMasterID,VoucherType,TotalVATAmount,"Dr","create")
                        ...
                        update_ledger = UpdateLedgerBalance(CompanyID,BranchID,Supplier.LedgerID,ExpenseMasterID,VoucherType,TotalVATAmount,"Cr","create")

                elif TaxType == 'GST Intra-state B2B':
                    if float(TotalCGSTAmount) > 0:
                        LedgerPostingID = get_auto_LedgerPostid(
                            model.LedgerPosting, BranchID, CompanyID)
                        ...
                        update_ledger = UpdateLedgerBalance(CompanyID,BranchID,35,ExpenseMasterID,VoucherType,TotalCGSTAmount,"Dr","create")
                        ...
                        update_ledger = UpdateLedgerBalance(CompanyID,BranchID,Supplier.LedgerID,ExpenseMasterID,VoucherType,TotalCGSTAmount,"Cr","create")

                    if float(TotalSGSTAmount) > 0:
                        ...
                        update_ledger = UpdateLedgerBalance(CompanyID,BranchID,41,ExpenseMasterID,VoucherType,TotalSGSTAmount,"Dr","create")
                        ...
                        update_ledger = UpdateLedgerBalance(CompanyID,BranchID,Supplier.LedgerID,ExpenseMasterID,VoucherType,TotalSGSTAmount,"Cr","create")

                elif TaxType == 'GST Inter-state B2B':
                    if float(TotalIGSTAmount) > 0:
                        LedgerPostingID = get_auto_LedgerPostid(
                            model.LedgerPosting, BranchID, CompanyID)
                        ...
                        update_ledger = UpdateLedgerBalance(CompanyID,BranchID,35,ExpenseMasterID,VoucherType,TotalIGSTAmount,"Dr","create")
                        ...
                        update_ledger = UpdateLedgerBalance(CompanyID,BranchID,Supplier.LedgerID,ExpenseMasterID,VoucherType,TotalIGSTAmount,"Cr","create")
                ...
                if float(RoundOff) > 0:
                    ...
                    update_ledger = UpdateLedgerBalance(CompanyID,BranchID,77,ExpenseMasterID,VoucherType,RoundOff,"Dr","create")
                    ...
                    update_ledger = UpdateLedgerBalance(CompanyID,BranchID,Supplier.LedgerID,ExpenseMasterID,VoucherType,RoundOff,"Cr","create")
                ...
                if float(RoundOff) < 0:
                    ...
                    update_ledger = UpdateLedgerBalance(CompanyID,BranchID,77,ExpenseMasterID,VoucherType,RoundOff,"Cr","create")
                    ...
                    update_ledger = UpdateLedgerBalance(CompanyID,BranchID,Supplier.LedgerID,ExpenseMasterID,VoucherType,RoundOff,"Dr","create")
                ...
                if float(TotalDiscount) > 0:
                    ...
                    update_ledger = UpdateLedgerBalance(CompanyID,BranchID,83,ExpenseMasterID,VoucherType,TotalDiscount,"Cr","create")
                    ...
                    update_ledger = UpdateLedgerBalance(CompanyID,BranchID,Supplier.LedgerID,ExpenseMasterID,VoucherType,TotalDiscount,"Dr","create")
                ...
                update_ledger = UpdateLedgerBalance(CompanyID,BranchID,PaymentLedgerID,ExpenseMasterID,VoucherType,Amount,"Cr","create")
                ...
                update_ledger = UpdateLedgerBalance(CompanyID,BranchID,Supplier.LedgerID,ExpenseMasterID,VoucherType,Amount,"Dr","create")
                ...
                for expenseDetail in expenseDetails:
                    ...
                    if LedgerID:
                        ...
                        DiscountAmount = float(expenseDetail['DiscountAmount'])
                        TaxableAmount = float(expenseDetail['TaxableAmount'])
                        TaxPerc = float(expenseDetail['TaxPerc'])
                        TaxAmount = float(expenseDetail['TaxAmount'])
                        NetTotal = float(expenseDetail['Total'])
                        VATPerc = float(expenseDetail['VATPerc'])
                        VATAmount = float(expenseDetail['VATAmount'])
                        IGSTPerc = float(expenseDetail['IGSTPerc'])
                        IGSTAmount = float(expenseDetail['IGSTAmount'])
                        SGSTPerc = float(expenseDetail['SGSTPerc'])
                        SGSTAmount = float(expenseDetail['SGSTAmount'])
                        CGSTPerc = float(expenseDetail['CGSTPerc'])
                        CGSTAmount = float(expenseDetail['CGSTAmount'])
                        ...
                        update_ledger = UpdateLedgerBalance(CompanyID,BranchID,Ledger.LedgerID,ExpenseMasterID,VoucherType,NetTotal,"Dr","create")
                        ...
                        update_ledger = UpdateLedgerBalance(CompanyID,BranchID,Supplier.LedgerID,ExpenseMasterID,VoucherType,NetTotal,"Cr","create")
...
def edit_expense(request, pk):
    try:
        with transaction.atomic():
            ...
            update_ledger = UpdateLedgerBalance(CompanyID,BranchID,0,ExpenseMasterID,"EX",0,"Cr","update")
            ...
            expense_instance.Payment = Payment
                ...
                for deleted_Data in deleted_datas:
                    ...
                    if not deleted_pk == '' or not deleted_pk == 0:
                        if model.ExpenseDetails.objects.filter(pk=deleted_pk).exists():
                            deleted_detail = model.ExpenseDetails.objects.filter(pk=deleted_pk).delete()
            ...
            for expenseDetail in expenseDetails:
                ...
                if LedgerID:
                    ...
                    if detailID == 0:
                        Detail_instance = model.ExpenseDetails.objects.get(pk=pk)
...
def delete_expense(request, pk):
    ...
    if model.ExpenseMaster.objects.filter(pk=pk).exists():
        ...
        if model.LedgerPosting.objects.filter(CompanyID=CompanyID, VoucherMasterID=ExpenseMasterID, BranchID=BranchID, VoucherType=VoucherType).exists():
            ...
            update_ledger = UpdateLedgerBalance(CompanyID,BranchID,0,ExpenseMasterID,VoucherType,0,"Cr","update")
