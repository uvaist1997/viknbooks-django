...
from brands.models import PurchaseReturnDetails, PurchaseReturnDetailsDummy, Product
...
class PurchaseReturnDetailsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id','BranchID','PurchaseReturnMasterID','DeliveryDetailsID','OrederDetailsID','ProductID',
            ...
            'NetAmount','AddlDiscPerc','AddlDiscAmt','TAX1Perc','TAX1Amount','TAX2Perc',
...
class PurchaseReturnDetailsRestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PurchaseReturnDetails
        fields = ('id','PurchaseReturnDetailsID','BranchID','Action','PurchaseReturnMasterID','DeliveryDetailsID','OrederDetailsID','ProductID',
        	'Qty','FreeQty','UnitPrice',
...
class PurchaseReturnDetailsDummySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PurchaseReturnDetailsDummy
        fields = ('id','unq_id','PurchaseReturnDetailsID','BranchID','PurchaseReturnMasterID','DeliveryDetailsID','OrderDetailsID','ProductID','ProductName','Qty','FreeQty','UnitPrice','RateWithTax','CostPerPrice',
            'PriceListID',
            'DiscountPerc','DiscountAmount','GrossAmount','TaxableAmount','VATPerc','VATAmount','SGSTPerc',
            'SGSTAmount','CGSTPerc','CGSTAmount','IGSTPerc','IGSTAmount','NetAmount','CreatedUserID','detailID',
            'AddlDiscPerc','AddlDiscAmt','TAX1Perc','TAX1Amount','TAX2Perc',
            'TAX2Amount','TAX3Perc','TAX3Amount')
...
class PurchaseReturnDetailsDeletedDummySerializer(serializers.ModelSerializer):

    class Meta:
        model = PurchaseReturnDetailsDummy
        fields = ('id','PurchaseReturnDetailsID','unq_id')