...
class ActivityLogSerializer(serializers.ModelSerializer):
    ...
    def get_device_name(self, instance):
        ...
        is_pc = instance.is_pc
        browser = instance.browser
        body_params = instance.body_params
        details = str("device_name") + ":" + str(device_name)+ "||" + str("is_pc") + ":" + str(is_pc)+ "||" + str("browser") + ":" + str(browser)+ "||" +  str("body_params") + ":" + str(body_params)
        return details
