...
from api.v7.organizations.serializers import OrganizationSettingsSerializer, OrganizationUserListSerializer, OrganizationListSerializer, OrganizationSerializer
from api.v7.organizations.functions import generate_serializer_errors
...
def create_organization_settings(request):
    ...
    if serializer.is_valid():
        ...
        try:
            ...
            Permission = ""
        instance = CompanySettings.objects.get(owner__pk=Customer, pk=Organization)
        if instance.NoOfUsers > NoOfUsers:
            response_data = {
            "StatusCode": 6001,
            "message": "can't reduce No of users"
            }
