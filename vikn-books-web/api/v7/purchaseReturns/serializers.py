...
from brands.models import Parties,QrCode,State,Country,PurchaseReturnMaster, PurchaseReturnDetails, AccountLedger, Product, PriceList, Warehouse, Unit, TaxCategory
...
class PurchaseReturnDetailsRestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PurchaseReturnDetails
        fields = ('id','NetAmount_print','VATAmount_print','VATPerc_print', 'NetAmount_print','unitPrice_print','PurchaseReturnDetailsID', 'BranchID', 'Action', 'PurchaseReturnMasterID', 'DeliveryDetailsID', 'OrderDetailsID', 'ProductID',
