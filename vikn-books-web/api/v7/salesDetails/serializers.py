...
from brands.models import SalesDetails, SalesDetailsDummy, Product
...
class SalesDetailsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SalesDetails
        fields = ('id','BranchID','Action','SalesMasterID','DeliveryDetailsID','OrederDetailsID','ProductID',
            ...
            'CGSTAmount','IGSTPerc','IGSTAmount','NetAmount','CreatedUserID','Flavour')
...
class SalesDetailsRestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SalesDetails
        fields = ('id','SalesDetailsID','BranchID','Action','SalesMasterID','DeliveryDetailsID','OrederDetailsID','ProductID',
            'Qty','FreeQty','UnitPrice',
            'RateWithTax','CostPerPrice','PriceListID','DiscountPerc','DiscountAmount',
            'GrossAmount','TaxableAmount','VATPerc','VATAmount','SGSTPerc','SGSTAmount','CGSTPerc',
            'CGSTAmount','IGSTPerc','IGSTAmount','NetAmount','CreatedDate','UpdatedDate','CreatedUserID','Flavour')



class SalesDetailsDummySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SalesDetailsDummy
        fields = ('id','unq_id','SalesDetailsID','BranchID','ProductID','ProductName','Qty','FreeQty','UnitPrice','RateWithTax','CostPerPrice','PriceListID',
            'TaxID','TaxType','DiscountPerc',
            'DiscountAmount','GrossAmount','TaxableAmount','VATPerc','VATAmount','SGSTPerc','SGSTAmount',
            'CGSTPerc','CGSTAmount','IGSTPerc','IGSTAmount','NetAmount','CreatedUserID','Flavour','totalQty','detailID',
...
class SalesDetailsDeletedDummySerializer(serializers.ModelSerializer):

    class Meta:
        model = SalesDetailsDummy
        fields = ('id','SalesDetailsID','unq_id')
