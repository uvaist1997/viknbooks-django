from brands.models import VoucherNoTable,PaymentMaster, PaymentMaster_Log, PaymentDetails, PaymentDetails_Log, LedgerPosting, LedgerPosting_Log, PaymentDetailsDummy,\
    TransactionTypes, CompanySettings, GeneralSettings, AccountLedger
from rest_framework.renderers import JSONRenderer
from rest_framework.decorators import api_view, permission_classes, renderer_classes,authentication_classes
from rest_framework.response import Response
from rest_framework_simplejwt.authentication import JWTTokenUserAuthentication
from api.v7.payments.serializers import PaymentMasterSerializer, PaymentMasterRestSerializer, PaymentDetailsSerializer, PaymentDetailsRestSerializer
from api.v7.payments.serializers import ListSerializer
from api.v7.payments.functions import generate_serializer_errors
from rest_framework import status
from api.v7.payments.functions import get_auto_id, get_auto_idMaster, get_auto_VoucherNo
...
from api.v7.receipts.functions import get_voucher_type
        ...
        with transaction.atomic():
            ...
            if is_PaymentsOK:
                ...
                for paymentsDetail in paymentsDetails:
                    ...
                    update_ledger = UpdateLedgerBalance(CompanyID,BranchID,LedgerID,PaymentMasterID,VoucherType,NetAmount,"Dr","create")
                    ...
                    update_ledger = UpdateLedgerBalance(CompanyID,BranchID,MasterLedgerID,PaymentMasterID,VoucherType,NetAmount,"Cr","create")
                    ...
                    if float(Discount) > 0:
                        ...
                        update_ledger = UpdateLedgerBalance(CompanyID,BranchID,82,PaymentMasterID,VoucherType,Discount,"Cr","create")
                        ...
                        update_ledger = UpdateLedgerBalance(CompanyID,BranchID,LedgerID,PaymentMasterID,VoucherType,Discount,"Dr","create")
...
def edit_payment(request, pk):
    try:
        with transaction.atomic():
            ...
            update_ledger = UpdateLedgerBalance(CompanyID,BranchID,0,PaymentMasterID,VoucherType,0,"Cr","update")
            ...
            if PaymentDetails.objects.filter(CompanyID=CompanyID, PaymentMasterID=PaymentMasterID, BranchID=BranchID, VoucherType=VoucherType).exists():
                paymentDetailInstances = PaymentDetails.objects.filter(
                    CompanyID=CompanyID, PaymentMasterID=PaymentMasterID, BranchID=BranchID, VoucherType=VoucherType).delete()
