from brands.models import Activity_Log, VoucherNoTable,State,PurchaseMaster, AccountLedger_Log,PurchaseMaster_Log, PurchaseDetails, PurchaseDetails_Log, StockPosting, LedgerPosting, StockPosting_Log,\
...
from api.v7.purchases.functions import generate_serializer_errors,purchase_gst_excel_data,export_to_excel_purchase_gst
from rest_framework import status
from api.v7.sales.serializers import ListSerializerforReport
from api.v7.purchases.functions import purchase_taxgroup_excel_data,export_to_excel_purchase_taxgroup,get_auto_id, get_auto_idMaster, get_auto_StockRateID, get_auto_StockTransID
...
from api.v7.purchaseOrders.serializers import PurchaseOrderMasterRestSerializer
...
def create_purchase(request):
    try:
            ...
            if is_PurchaseOK:
                ...
                for purchaseDetail in purchaseDetails:
                    ...
                    if ProductID:
                        ...
                        DiscountPerc = 0
                        if purchaseDetail['DiscountPerc']:
                            DiscountPerc = float(purchaseDetail['DiscountPerc'])
                        DiscountAmount = 0
                        if purchaseDetail['DiscountAmount']:
        ...
        activity_id = activity_log(request._request, CompanyID, 'Error', CreatedUserID, 'Purchase',
