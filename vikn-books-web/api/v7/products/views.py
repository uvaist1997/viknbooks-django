...
from api.v7.products.serializers import ProductSerializer, SingleProductRestSerializer, ProductRestSerializer, ProductbyGrouptSerializer, BarCodeSearchSerializer, UploadSerializer, ProductSearchShortcutSerializer, ListSerializerforReport, StockSerializer,ProductSearchSerializer
from api.v7.priceLists.serializers import PriceListSerializer, PriceListRestSerializer
from api.v7.brands.serializers import ListSerializer
from api.v7.products.functions import generate_serializer_errors, generate_priceList_serializer_errors,get_auto_ProductBarcode
from rest_framework import status
from api.v7.products.functions import get_auto_id, get_auto_priceListid, get_ProductCode, get_auto_AutoBarcode, get_auto_BatchNo, get_auto_AutoBatchCode
import datetime
...
from api.v7.products.tasks import import_product_task
from celery.result import AsyncResult
from api.v7.products.utils import in_memory_file_to_temp
from django.db.models import Max, Q, Prefetch, Sum
import time
from api.v7.products.serializers import ProductSearchInvoiceSerializer
...
def edit_product(request, pk):
    ...
    if product_serialized.is_valid():
        ...
        if not contains_duplicates:
            ...
            print(productCode_ok,'productCode_okproductCode_okproductCode_okproductCode_okproductCode_ok',InstanceProductCode,)
