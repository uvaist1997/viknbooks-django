...
from api.v7.priceLists.serializers import PriceListRestSerializer, SinglePriceListRestSerializer
from api.v7.workOrder.serializers import Batch_ListSerializer, UnitListSerializer
...
class ProductSearchSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ('id','Description', 'ProductID','ProductCode','Barcode','ProductName','Stock','HSNCode','PurchasePrice','SalesPrice','is_inclusive')
