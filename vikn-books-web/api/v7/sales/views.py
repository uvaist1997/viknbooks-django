...
from api.v8.sales.functions import sales_taxgroup_excel_data
...
from api.v7.sales.serializers import GST_CDNR_Serializer, GST_B2B_Serializer, SalesEstimateForOrderSerializer, SalesMasterSerializer, SalesMasterRestSerializer, SalesMasterRest1Serializer, SalesDetailsSerializer,\
...
from api.v7.salesOrders.serializers import SalesOrderDetailsRestSerializer
from api.v7.purchases.serializers import PurchaseMasterRestSerializer, PurchasePrintSerializer
from api.v7.salesReturns.serializers import SalesReturnMasterRestSerializer, SalesReturnMasterReportSerializer
from api.v7.purchaseReturns.serializers import PurchaseReturnMasterRestSerializer, PurchaseReturnPrintSerializer
from api.v7.sales.functions import export_to_excel_sales_taxgroup, sales_gst_excel_data, export_to_excel_sales_gst, set_LoyaltyCalculation, get_Program, edit_LoyaltyCalculation, generate_serializer_errors, get_month, get_stock_value, b2b_suppliers_excel, b2cl_excel, b2cs_excel, cdnr_excel, cdnur_excel, hsn_excel, default_b2cl_excel,\
...
from api.v7.sales.functions import get_auto_id, get_auto_idMaster, get_auto_stockPostid, get_date_list, gstr1_data
from api.v7.accountLedgers.serializers import AccountLedgerListSerializer
...
from api.v7.stockPostings.serializers import StockPostingSerializer, StockPostingRestSerializer, ExcessStockMasterSerializer, ShortageStockMasterSerializer, DamageStockMasterSerializer, UsedStockMasterSerializer, UsedStockDetailSerializer
from api.v7.companySettings.serializers import CompanySettingsRestSerializer, QRCompanySettingsRestSerializer
from api.v7.settings.serializers import QRPrintSettingsSerializer
from api.v7.products.functions import get_auto_AutoBatchCode, update_stock
from django.db.models import Max
from api.v7.salesOrders.serializers import SalesOrderMasterRestSerializer
from api.v7.purchaseOrders.serializers import PurchaseOrderPrintSerializer
...
from api.v7.accountLedgers.functions import get_auto_LedgerPostid, get_LedgerCode, get_auto_id as generated_ledgerID, UpdateLedgerBalance
import math
from operator import itemgetter
from api.v7.sales.tasks import taskAPIfor_gstr1_report
...
def generate_printReport(request):
    from api.v7.sales.serializers import SalesPrintSerializer
    from api.v7.salesReturns.serializers import SalesReturnMasterPrintSerializer
    data = request.data
    CompanyID = data['CompanyID']
    CompanyID = get_company(CompanyID)
    CreatedUserID = data['CreatedUserID']
