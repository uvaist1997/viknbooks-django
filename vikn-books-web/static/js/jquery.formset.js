...
;(function($) {
    ...
    $.fn.formset.defaults = {
        ...
        addCssClass: 'btn-blue waves-effect waves-light btn fas fa-plus',          // CSS class applied to the add link
        deleteCssClass: 'btn mdi mdi-delete',    // CSS class applied to the delete link
